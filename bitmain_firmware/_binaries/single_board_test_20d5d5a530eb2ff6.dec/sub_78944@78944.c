int __fastcall sub_78944(int a1, unsigned int a2, unsigned int a3, unsigned int a4, int a5)
{
  unsigned int v5; // r4
...
LABEL_7:
    ...
    v13 = &dword_65EA50[128 * (a3 + (a2 << 8)) + 2 * v5];
    if ( a4 != v13[512] )
    {
      v10 = a2 << 6;
      v11 = -5;
  ...
  else
  {
    ...
    v15 = a2 << 14;
    v16 = (char *)&unk_65F250 + 8 * v15 + 8 * v5;
    dword_65EA50[2 * v14 + 1] = a5;
    do
    {
      *((_DWORD *)v16 + 1) = a5;
      v16 += 512;
    }
    while ( v16 != (char *)&unk_65F250 + 8 * v15 + 8 * v5 + 0x20000 );
  }
  pthread_mutex_unlock(&stru_6DF250);
  return 0;
}
