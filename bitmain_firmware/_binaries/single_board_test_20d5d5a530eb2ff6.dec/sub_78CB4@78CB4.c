int __fastcall sub_78CB4(unsigned int a1, int a2, int (__fastcall *a3)(char *, int, int), int a4, __int16 a5)
{
  unsigned int v9; // r9
  unsigned int v10; // r4
  char *v11; // r0
  ...
  while ( 1 )
  {
    ...
    if ( v10 != a1 && a3((char *)a1, v10 - a1, a4) )
      return -1;
    if ( v13 == v10 )
      return a3("\"", 1, a4);
    if ( v19 == 12 )
