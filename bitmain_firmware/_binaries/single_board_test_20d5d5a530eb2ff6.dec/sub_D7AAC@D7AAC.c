bool __fastcall sub_D7AAC(_DWORD *a1, int a2, int *a3, char *a4, signed int a5)
{
  signed int v5; // r4
  unsigned int v10; // r7
  int v11; // r0
...
LABEL_41:
  ...
  v5 = a5 - v19;
  if ( 0x7FFFFFFF - v12 < (int)(-v12 & (a5 - v19)) )
  {
    sub_D0048(6, 219, 184, (int)"crypto/evp/evp_enc.c", 370);
    return v14;
  }
  memcpy((char *)a1 + v16 + 48, a4, v19);
...
LABEL_22:
    if ( v17 )
      memcpy(a1 + 12, &a4[v18], v17);
    a1[3] = v17;
    return 1;
  }
  if ( (*(int (__fastcall **)(_DWORD *, int, char *, int))(*a1 + 24))(a1, a2, a4, v18) )
  {
    *a3 += v18;
    goto LABEL_22;
  }
