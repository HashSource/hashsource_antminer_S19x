unsigned int __fastcall SM4_decrypt(unsigned int *a1, _BYTE *a2, int *a3)
{
  unsigned int v3; // r4
  unsigned int v4; // r7
  unsigned int v5; // r12
