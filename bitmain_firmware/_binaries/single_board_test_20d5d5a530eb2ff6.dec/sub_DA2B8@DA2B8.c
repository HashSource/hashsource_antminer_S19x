_DWORD *__fastcall sub_DA2B8(int a1, _DWORD *a2, int a3, int a4)
{
  _DWORD *v8; // r0
  _DWORD *v9; // r4
  int *v10; // r6
  ...
  v16 = (int (__fastcall *)(_DWORD *, int, int))v13[32];
  if ( v16 )
  {
    if ( v16(v9, a3, a4) )
      return v9;
    sub_D0048(6, 191, 180, (int)"crypto/evp/p_lib.c", 247);
  }
  else
  {
    sub_D0048(6, 191, 150, (int)"crypto/evp/p_lib.c", 242);
  }
LABEL_22:
  sub_DA240((int)v9);
  return 0;
