int __fastcall sub_637D4(int a1, signed int a2, int a3)
{
...
LABEL_6:
  ...
  if ( (*(_DWORD *)(a1 + 52) & 8) != 0 || v6 == 46 || v6 == 69 || v6 == 101 )
  {
    ...
    sub_62EE8((_DWORD *)a1, v6);
    if ( sub_653FC(a1 + 40, &v9) )
    {
      sub_627E0(a3, (_DWORD *)a1, 15, "real number overflow");
      return -1;
    }
    *(_DWORD *)(a1 + 60) = 258;
    *(_QWORD *)(a1 + 64) = v9;
  ...
  {
    sub_62EE8((_DWORD *)a1, v6);
    nptr = (char *)sub_65080(a1 + 40);
    *_errno_location() = 0;
    v11 = strtoll(nptr, &endptr, 10);
    if ( *_errno_location() == 34 )
    {
      if ( v11 >= 0 )
        sub_627E0(a3, (_DWORD *)a1, 15, "too big integer");
      else
        sub_627E0(a3, (_DWORD *)a1, 15, "too big negative integer");
      return -1;
    }
