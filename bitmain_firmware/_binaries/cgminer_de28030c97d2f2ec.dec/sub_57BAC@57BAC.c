int __fastcall sub_57BAC(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  size_t v4; // r3
  size_t v6; // r3
  ...
  if ( !memcmp(a3, &a3[v13], n) )
  {
    ...
    while ( a2 - a4 >= v18 )
    {
      ...
      else
      {
        ...
        if ( n >= v17 )
          v4 = n;
        for ( i = v4; a4 - 1 > i && a3[i] == *(unsigned __int8 *)(a1 + i + v18); ++i )
          ;
        if ( a4 - 1 > i )
        {
          v18 += i - n + 1;
        ...
        {
          for ( i = n - 1; i + 1 > v17 && a3[i] == *(unsigned __int8 *)(a1 + i + v18); --i )
            ;
          if ( i + 1 < v17 + 1 )
            return a1 + v18;
          v18 += v13;
  ...
  else
  {
    ...
    while ( a2 - a4 >= v18 )
    {
      ...
      {
        for ( i = n; a4 - 1 > i && a3[i] == *(unsigned __int8 *)(a1 + i + v18); ++i )
          ;
        if ( a4 - 1 > i )
        {
          v18 += i - n + 1;
