const char *__fastcall sub_1B0A0(char *a1, int a2)
{
  ...
  for ( i = 0; i < v12; ++i )
  {
    result = (const char *)sub_65FEC(a2, v9[i]);
    v18 = result;
    if ( result )
    {
      if ( *(_DWORD *)v18 == 1 )
  ...
  if ( i < v12 )
  {
    ...
    result = (const char *)sub_66B34(v18);
    v11 = result;
    for ( j = 0; (int)j < (int)v11; ++j )
    {
      result = (const char *)sub_66B80(v18, j);
      v14 = result;
