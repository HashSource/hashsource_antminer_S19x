int sub_1B868()
{
  ...
  v33 = (void (__fastcall *)(int *))sub_1AE94;
  p_fd = &fd;
  if ( _sigsetjmp(&v5, 0) )
  {
    v33(p_fd);
  ...
  while ( byte_87750 != 1 )
  {
    ...
    if ( v30 > 0 )
    {
      v22[v30] = 0;
      memset(v20, 0, sizeof(v20));
      memset(byte_87758, 0, sizeof(byte_87758));
      dword_87754 = time(0);
      getnameinfo(&addr, 0x80u, byte_87758, 0x10u, 0, 0, 1u);
      if ( byte_87768 && (byte_91F58 || byte_87769 || dword_8697C > 6) )
      {
        snprintf(v12, 0x800u, "connect_addr: %s", byte_87758);
        sub_1E4EC(7, v12, 0);
      }
      strlen(v22);
      v2 = sub_1B588(&v25, (int)v22);
      v31 = v2;
      if ( v2 )
      {
        v29 = sub_65ED4(v2);
        v3 = strlen(v22);
        v31 = sub_1A5D4(v22, v3 + 1, v20, &v19);
        if ( v31 >= 0 )
        {
          sub_1AC28(v29, v20, v19);
        }
        else
        {
          if ( byte_91F58 || byte_87769 || dword_8697C > 2 )
          ...
          sub_15B04(v29, 0, 24, "Missing JSON 'command'");
        }
        if ( v19 == 2 )
        {
          memset(v21, 0, sizeof(v21));
        ...
        {
          ptr = (void *)sub_605A4(v29, 24576);
          sub_1A7A4(&v25, (char *)ptr);
          sub_13310(v29);
          free(ptr);
        }
      }
