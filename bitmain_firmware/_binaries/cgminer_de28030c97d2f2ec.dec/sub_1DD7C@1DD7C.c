const char **__fastcall sub_1DD7C(const char **result, int a2, const char *a3, const char *a4, int a5)
{
  ...
  {
    if ( *(_DWORD *)(a2 + 16) )
      *(_DWORD *)(*(_DWORD *)(a2 + 16) + 8) = result[3];
    else
      *(_DWORD *)(a2 + 12) = result[3];
    *((_DWORD *)result[3] + 1) = *(_DWORD *)(a2 + 16);
