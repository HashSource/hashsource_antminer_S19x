int __fastcall sub_62A14(int a1, int a2)
{
  int v3; // r3
  ...
  if ( !*(_BYTE *)(a1 + *(_DWORD *)(a1 + 16) + 8) )
  {
    ...
    *(_DWORD *)(a1 + 16) = 0;
    ...
    {
      v7 = sub_658F8((unsigned __int8)v8);
      if ( !v7 )
        goto LABEL_22;
      if ( v7 <= 1 )
      ...
      for ( i = 1; i < v7; *(_BYTE *)(a1 + i++ + 8) = (*(int (__fastcall **)(_DWORD))a1)(*(_DWORD *)(a1 + 4)) )
        ;
      if ( !sub_659E4(a1 + 8, v7, 0) )
      {
LABEL_22:
        *(_DWORD *)(a1 + 20) = -2;
        sub_627E0(a2, (_DWORD *)a1, 5, "unable to decode byte 0x%x", v8);
        return -2;
      }
      *(_BYTE *)(a1 + v7 + 8) = 0;
    }
  ...
  *(_DWORD *)(a1 + 16) = v3 + 1;
  ...
  else if ( sub_658F8((unsigned __int8)v9) )
  {
    ++*(_DWORD *)(a1 + 28);
  }
  return v9;
