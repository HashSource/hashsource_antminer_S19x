int __fastcall sub_5E530(int a1)
{
  pthread_t v1; // r0
  size_t v2; // r0
  size_t v3; // r0
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)s1 = 0;
    ...
    if ( !strcmp(s1, "regist") )
    {
      ptr = malloc(0x98u);
      memset(ptr, 0, 0x98u);
      for ( i = 0; i < dword_8DDB8; ++i )
      {
        if ( !strcmp(src, (const char *)&unk_899B8 + 136 * i + 4) )
        {
          *((_DWORD *)ptr + 3) = *((_DWORD *)&unk_899B8 + 34 * i);
          *((_DWORD *)ptr + 37) = *((_DWORD *)&unk_899B8 + 34 * i + 33);
          break;
        }
      }
      if ( i == dword_8DDB8 )
      ...
      {
        *(_DWORD *)ptr = dword_87718;
        v3 = strlen(src);
        memcpy((char *)ptr + 16, src, v3 + 1);
        *((_DWORD *)ptr + 36) = 0;
        pthread_create(&newthread, &attr, (void *(*)(void *))sub_5E1C8, ptr);
        while ( !*((_DWORD *)ptr + 36) )
          usleep(0x2710u);
        if ( *(_DWORD *)ptr != dword_87718 )
          dword_87718 = *(_DWORD *)ptr;
        *(_DWORD *)v23 = 0;
        memset(v24, 0, sizeof(v24));
        sprintf(v23, "%x %d %s %s %s", 63, dword_87718, "reg_resp", "OK", src);
        v4 = strlen(v23);
        send(fd, v23, v4 + 1, 0);
        ++dword_87718;
      }
    ...
    {
      memcpy((char *)&unk_8DDDC + 128 * dword_91DDC, buf, 0x80u);
      ++dword_91DDC;
    }
  }
}
