int __fastcall sub_4F274(const char *a1)
{
  char *v2; // r4
  const char *v3; // r0
  char *v4; // r4
  ...
  if ( a1 )
  {
    ...
    if ( v21 && !*v21 )
    {
      ...
      v20 = (_DWORD *)sub_65FEC(v21, "pools");
      if ( v20 && *v20 == 1 )
      {
        v17 = sub_66B34(v20);
        for ( i = 0; ; ++i )
        {
          ...
          if ( i > 2 )
            break;
          v18 = (_DWORD *)sub_65FEC(v19, "url");
          if ( !v18 )
            break;
          if ( *v18 != 2 )
            break;
          v2 = (char *)&v13[48 * i];
          v3 = (const char *)sub_677D0(v18);
          snprintf(v2, 0x100u, "%s", v3);
          v18 = (_DWORD *)sub_65FEC(v19, "user");
          if ( !v18 )
            break;
          if ( *v18 != 2 )
            break;
          v4 = (char *)&v13[48 * i + 16];
          v5 = (const char *)sub_677D0(v18);
          snprintf(v4, 0x100u, "%s", v5);
          v18 = (_DWORD *)sub_65FEC(v19, "pass");
          if ( !v18 || *v18 != 2 )
            break;
          v6 = (char *)&v13[48 * i + 32];
          v7 = (const char *)sub_677D0(v18);
        ...
        if ( dword_92028 == v17 )
        {
          ...
          {
            if ( strcmp(*(const char **)(*(_DWORD *)(dword_920CC + 4 * i) + 164), (const char *)&v13[48 * i])
              || strcmp(*(const char **)(*(_DWORD *)(dword_920CC + 4 * i) + 172), (const char *)&v13[48 * i + 16])
              || strcmp(*(const char **)(*(_DWORD *)(dword_920CC + 4 * i) + 176), (const char *)&v13[48 * i + 32]) )
            {
              v23 |= 1u;
              break;
            }
      ...
      v18 = (_DWORD *)sub_65FEC(v21, "bitmain-freq-level");
      if ( v18 && *v18 == 2 )
      {
        v9 = (const char *)sub_677D0(v18);
        v16 = atoi(v9);
        if ( dword_86C64 == v16 )
        {
          v23 &= ~2u;
