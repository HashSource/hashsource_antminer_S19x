  ...
  if ( v9 )
  {
    ...
    if ( result >= 0 )
    {
      ...
      *(double *)(v10 + 88) = (double)v12 / v4 * 60.0;
      ...
      v17 = sub_18850(0, "ASC", 6, (const char *)&v48, 0);
      ...
      v22 = sub_18850((int)v21, "Temperature", 19, (const char *)&v49, 0);
      v52 = *(double *)(v10 + 80) / v51;
      v23 = sub_18850((int)v22, "MHS av", 17, (const char *)&v52, 0);
      ...
      if ( *(int *)(v10 + 220) <= 0 )
        ...
        v29 = *(_DWORD *)(v10 + 216);
      v50 = v29;
      v30 = sub_18850((int)v28, "Last Share Pool", 6, (const char *)&v50, 0);
      ...
      if ( v40 )
        v41 = (double)v38 / sub_4A11C(v40, HIDWORD(v40), (unsigned int)v40 | HIDWORD(v40), v38);
      else
        v41 = 0.0;
      v53 = v41;
      v43 = sub_18850(v39, "Device Hardware%", 25, (const char *)&v53, 0);
      v44 = *(_QWORD *)(v10 + 192);
      if ( v44 )
        v45 = *(double *)(v10 + 208) / sub_4A11C(v44, HIDWORD(v44), v42, (unsigned int)v44 | HIDWORD(v44));
      else
        v45 = 0.0;
      v54 = v45;
      v46 = sub_18850((int)v43, "Device Rejected%", 25, (const char *)&v54, 0);
      v47 = (char **)sub_18850((int)v46, "Device Elapsed", 13, (const char *)&v51, 0);
      return sub_17D00(a1, v47, a3, a4);
    }
  }
  return result;
}
