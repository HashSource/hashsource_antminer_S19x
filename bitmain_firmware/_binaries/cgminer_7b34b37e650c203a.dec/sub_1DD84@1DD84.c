...
LABEL_233:
  ...
  if ( byte_7347D )
    sub_1DC74();
  v98 = 0;
  dword_68AA4 = sub_200F8("StrBufs", 12, 2, 0, 0, "api.c", "api", 5311);
  while ( 1 )
  {
    ...
    if ( v100 )
    {
      ...
      if ( v102 >= 0 )
      {
        ...
        *v106 = 0;
        ...
        if ( v107 == 123 )
        {
          v127 = (_DWORD *)sub_47320(v202, v103, 0, v168);
          v144 = v127;
          if ( v127 && !*v127 )
          {
...
LABEL_283:
  ...
  else
  {
    if ( !byte_68A7D )
      goto LABEL_297;
    if ( sub_25164(v162, (unsigned __int8)byte_68A7E, sub_179F4) )
    {
      if ( pthread_mutex_unlock(&stru_68A88) )
        sub_17668("api", 5536);
      off_67ED8();
