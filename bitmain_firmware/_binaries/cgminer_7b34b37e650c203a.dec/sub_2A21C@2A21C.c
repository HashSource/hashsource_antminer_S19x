void __fastcall sub_2A21C(_DWORD *a1, char *a2, int a3)
{
  int v5; // r0
  int v6; // r1
  int v7; // r2
  ...
  v35 = "o";
  v36 = sub_22C24((int)v54, 32);
  v37 = sub_22C24((int)&v56, 12);
  v51 = sub_22C24((int)a2, 4);
  v38 = sub_22C24((int)a2, 5);
  v39 = sub_22C24((int)v60, 32);
  v40 = sub_2CDF0(a1);
  HIDWORD(v52) = v41;
  if ( !a3 )
    v35 = "x";
  ...
  else
  {
    ...
    if ( dword_6A974 )
    {
      sprintf(
        ...
        v52);
      v42 = strlen(s);
      fwrite(s, v42, 1u, (FILE *)dword_6A974);
      ...
      if ( a3 )
      {
        if ( dword_6A970 == 1 )
        {
          ...
          v48 = strlen(s);
          fwrite(s, v48, 1u, (FILE *)dword_6A978[0]);
        ...
        {
          sprintf(s, "midstate %s data %s nonce %s hash %s", v36, v37, v51, v39);
          v43 = sub_29F34(dword_6A970, *a2);
          v44 = strlen(s);
          fwrite(s, v44, 1u, (FILE *)dword_6A978[v43]);
          fwrite(&word_4C858, 1u, 1u, (FILE *)dword_6A978[v43]);
          fflush((FILE *)dword_6A978[v43]);
        }
        if ( byte_6AA7C )
        {
          v45 = v52;
          ...
          if ( byte_68BD5 && (*v53 || byte_68BD4 || dword_67DB4 > 6) )
          {
          ...
          sprintf(s, "midstate %s data %s nonce %s hash %s", v36, v37, v51, v39);
          v47 = strlen(s);
          fwrite(s, v47, 1u, *((FILE **)&unk_6AA80 + i));
