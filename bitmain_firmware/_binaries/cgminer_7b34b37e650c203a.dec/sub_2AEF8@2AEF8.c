int __fastcall sub_2AEF8(unsigned __int64 a1, char *s, size_t maxlen, int a4)
{
  ...
  if ( a1 <= 0xDE0B6B3A763FFFFLL )
  {
    if ( a1 <= 0x38D7EA4C67FFFLL )
    {
      ...
      {
        LODWORD(a1) = sub_4A178(a1, HIDWORD(a1), 1000000000, 0);
        v10 = 84;
      ...
      else if ( a1 <= 0x3B9AC9FF )
      {
        if ( a1 > 0xF423F )
        {
          LODWORD(a1) = sub_4A178(a1, HIDWORD(a1), 1000, 0);
          v10 = 77;
          v6 = (double)(int)a1 / 1000.0;
          if ( !a4 )
            return snprintf(s, maxlen, "%.3g%s", v6, (const char *)&v10);
      ...
      {
        LODWORD(a1) = sub_4A178(a1, HIDWORD(a1), 1000000, 0);
        v10 = 71;
        v6 = (double)(int)a1 / 1000.0;
        if ( !a4 )
          return snprintf(s, maxlen, "%.3g%s", v6, (const char *)&v10);
    ...
    {
      LODWORD(a1) = sub_4A178(a1, HIDWORD(a1), -727379968, 232);
      v10 = 80;
      v6 = (double)(int)a1 / 1000.0;
      if ( !a4 )
        return snprintf(s, maxlen, "%.3g%s", v6, (const char *)&v10);
  ...
  {
    LODWORD(a1) = sub_4A178(a1, HIDWORD(a1), -1530494976, 232830);
    v10 = 69;
    v6 = (double)(int)a1 / 1000.0;
    if ( !a4 )
      return snprintf(s, maxlen, "%.3g%s", v6, (const char *)&v10);
