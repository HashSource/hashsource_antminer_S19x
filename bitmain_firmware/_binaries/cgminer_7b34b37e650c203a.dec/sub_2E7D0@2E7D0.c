int __fastcall sub_2E7D0(char *a1, size_t a2, int a3)
{
  ...
  sub_2CC3C(a3);
  v9 = sub_4A11C(*(_DWORD *)(a3 + 192), *(_DWORD *)(a3 + 196), v7, v8) / v3;
  v10 = sub_4A1D8(
  ...
  sub_2AEF8(v11, v14, 0x10u, 4);
  sub_2AEF8(v10, v15, 0x10u, 4);
  ...
  if ( v12 + strlen(s) >= a2 )
  {
    snprintf(v17, 0x800u, "tailsprintf buffer overflow in %s %s line %d", "cgminer.c", "get_statline", 3118);
    sub_20F58(3, v17, 1);
    sub_2E6B0(1, 1);
  }
  strcat(a1, s);
