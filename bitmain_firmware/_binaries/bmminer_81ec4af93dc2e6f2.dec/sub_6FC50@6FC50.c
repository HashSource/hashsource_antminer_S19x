int __fastcall sub_6FC50(_DWORD *a1, int a2)
{
  int result; // r0
  int v3; // r3
  _BYTE *v4; // r2
  ...
  a1[16] = 0;
  a1[15] = -1;
  v14 = sub_6F938((int)a1, a2);
  while ( v14 != 34 )
  {
    if ( v14 == -2 )
      return sub_6FAD8((int)a1);
    if ( v14 == -1 )
    {
      sub_6F2A8(a2, a1, 6, "premature end of input");
      return sub_6FAD8((int)a1);
    }
    if ( (unsigned int)v14 < 0x20 )
    {
      sub_6F9C4(a1, v14);
      if ( v14 == 10 )
        sub_6F2A8(a2, a1, 8, "unexpected newline");
      else
        sub_6F2A8(a2, a1, 8, "control character 0x%x", v14);
      return sub_6FAD8((int)a1);
    }
    if ( v14 == 92 )
    {
      ...
      if ( v14 != 117 )
      {
        ...
        {
LABEL_18:
          sub_6F2A8(a2, a1, 8, "invalid escape");
          return sub_6FAD8((int)a1);
        }
        goto LABEL_32;
      }
...
LABEL_32:
  ...
  v12 = (_BYTE *)sub_7188C(a1[11] + 1);
  if ( !v12 )
    return sub_6FAD8((int)a1);
  a1[16] = v12;
  result = sub_71B7C(a1 + 10);
  v13 = (_BYTE *)(result + 1);
  while ( *v13 != 34 )
  {
    if ( *v13 == 92 )
    {
      if ( *++v13 == 117 )
      {
        ...
        if ( v10 < 55296 || v10 >= 56320 )
        {
          ...
          {
LABEL_52:
            sub_6F2A8(a2, a1, 8, "invalid Unicode '\\u%04X'", v10);
            return sub_6FAD8((int)a1);
          }
        }
        else
        {
          ...
          {
LABEL_39:
            sub_6F2A8(a2, a1, 8, "invalid Unicode escape '%.6s'", v13 - 1);
            return sub_6FAD8((int)a1);
          }
          v13 += 5;
          if ( v9 < 56320 || v9 >= 57344 )
          {
            sub_6F2A8(a2, a1, 8, "invalid Unicode '\\u%04X\\u%04X'", v10, v9);
            return sub_6FAD8((int)a1);
          }
          v10 = ((v10 - 55296) << 10) + v9 - 56320 + 0x10000;
        }
        result = sub_72200(v10, v12, &v8);
        if ( result )
