int __fastcall sub_4EEB8(_DWORD *a1, const char **a2, int *a3, void (*a4)(const char *, ...))
{
  bool v8; // zf
  int result; // r0
  const char **v10; // r6
  ...
  if ( !v8 )
  {
    ...
    if ( *(_BYTE *)(result + 1) == 45 )
      goto LABEL_23;
LABEL_15:
    v14 = (unsigned __int8 *)sub_4EB74(&v40);
    if ( v14 )
    {
      v15 = *a3 + 1;
...
LABEL_23:
  ...
  while ( 1 )
  {
    ...
    if ( !v28[v29 + 2] )
    {
      ...
      v17 = 28 * v40;
      n[0] = v30;
      v18 = dword_9C8A5C + 28 * v40;
      if ( *(_DWORD *)(v18 + 4) == 1 )
        goto LABEL_37;
      goto LABEL_34;
    }
LABEL_35:
    v26 = sub_4EB1C((int)v26, &v40, n);
    if ( !v26 )
      goto LABEL_36;
  }
  v16 = v40;
...
LABEL_20:
  v20 = dword_9C8A5C;
  v21 = dword_9C8A5C + v17;
  if ( *(_DWORD *)(v21 + 4) == 4 )
  {
    sub_4E3CC((int)v19, *(_DWORD **)(v21 + 20));
    v16 = v40;
    v20 = dword_9C8A5C;
  }
