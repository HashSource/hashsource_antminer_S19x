void __fastcall sub_894E0(int (__fastcall **a1)(const void *), const void *a2)
{
  int v2; // r0
  int v3; // r1
  int v4; // r1
  ...
  if ( a1 && a2 )
  {
    ...
    {
      sub_89984(2, "src/zc_hashtable.c", 251, "p[%p] not found in hashtable", 0);
    }
  }
  else
  {
    sub_89984(2, "src/zc_hashtable.c", 240, "a_table[%p] or a_key[%p] is NULL, just do nothing", a1, a2);
  }
}
