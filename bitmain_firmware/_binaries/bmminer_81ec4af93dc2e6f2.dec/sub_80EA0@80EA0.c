void *__fastcall sub_80EA0(int a1, const char *a2)
{
  int *v3; // r0
  int *v4; // r0
  ...
  if ( ptr )
  {
    ...
    if ( v9 <= 0x400 )
    {
      ...
      if ( !*(_DWORD *)(a1 + 1076) || *(_DWORD *)(a1 + 1076) <= v8 )
        return ptr;
      sub_89984(1, "src/rotater.c", 164, "aa.1.log is not expect, need aa.01.log");
    }
    else
    {
      v4 = _errno_location();
      sub_89984(2, "src/rotater.c", 155, "snprintf fail or overflow, nwrite=[%d], errno[%d]", v9, *v4);
    }
    free(ptr);
    return 0;
  }
  v3 = _errno_location();
  sub_89984(2, "src/rotater.c", 149, "calloc fail, errno[%d]", *v3);
  return 0;
}
