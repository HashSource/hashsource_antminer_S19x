char *__fastcall sub_2ECA8(const char *a1)
{
  const char *v2; // r4
  char *v3; // r6
  size_t v4; // r0
...
LABEL_37:
      if ( byte_5BC044 || byte_4B6CA5 || dword_AFC2C > 4 )
      {
        ...
        sub_3AF5C(5, v34, 0, *(_DWORD *)"reate failed\n");
        return v23;
      }
    }
    else
...
LABEL_39:
        ...
        else if ( byte_5BC044 || byte_4B6CA5 || dword_AFC2C > 4 )
        {
  ...
  sub_3AF5C(5, v34, 0, *(unsigned __int16 *)"");
  return 0;
}
