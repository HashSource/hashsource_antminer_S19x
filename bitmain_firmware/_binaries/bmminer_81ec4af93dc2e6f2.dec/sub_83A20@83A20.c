int __fastcall sub_83A20(int a1, int a2)
{
  ...
  if ( *(_DWORD *)(a1 + 8324) )
  {
    *(_DWORD *)(*(_DWORD *)(a2 + 16) + 4) = **(_DWORD **)(a2 + 16);
    ...
    while ( v8 < *(_DWORD *)(*(_DWORD *)(a1 + 5172) + 4) )
    {
      ...
      {
        sub_89984(2, "src/rule.c", 417, "zlog_spec_gen_path fail");
        return -1;
      }
      ++v8;
    }
    **(_BYTE **)(*(_DWORD *)(a2 + 16) + 4) = 0;
    ...
    {
      sub_89984(2, "src/rule.c", 420, "zlog_format_gen_msg fail");
      return -1;
    }
    else
    {
      **(_BYTE **)(*(_DWORD *)(a2 + 28) + 4) = 0;
      ...
      {
        sub_89984(2, "src/rule.c", 430, "a_rule->record fail");
        return -1;
      }
      else
      {
