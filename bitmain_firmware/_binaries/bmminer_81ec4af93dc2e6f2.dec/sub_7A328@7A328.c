int __fastcall sub_7A328(int result, const char *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( (((int)*(unsigned __int8 *)(result + a7 / 8 + 1032) >> (7 - a4)) & 1) != 0 )
  {
    ...
    if ( !dword_5BA7A0 )
    {
      sub_89984(2, "src/zlog.c", 647, "never call zlog_init() or dzlog_init() before");
    ...
    if ( !pointer )
    {
      ...
      if ( !pointer )
      {
        sub_89984(2, "src/zlog.c", 651, "zlog_thread_new fail");
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
      ...
      {
        sub_87E68(pointer);
        sub_89984(2, "src/zlog.c", 651, "pthread_setspecific fail, rd[%d]", v13);
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
    }
    if ( *pointer != dword_5BA7A4 )
    {
      ...
      {
        sub_89984(2, "src/zlog.c", 651, "zlog_thread_resize_msg_buf fail, rd[%d]", v14);
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
      *pointer = dword_5BA7A4;
    }
    sub_7F2EC(pointer[2], v12, *(_DWORD *)(v12 + 1028), a2, a3, v9, a5, a6, a7, a8, a9);
    if ( sub_7CAA8(v12, pointer) )
    {
      sub_89984(2, "src/zlog.c", 659, "zlog_output fail, srcfile[%s], srcline[%ld]", a2, a6);
      return pthread_rwlock_unlock(&stru_5BA76C);
    }
