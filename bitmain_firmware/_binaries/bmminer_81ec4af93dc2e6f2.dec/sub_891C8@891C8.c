int __fastcall sub_891C8(int a1, int a2, int a3)
{
  int v3; // r0
  int v4; // r1
  int *v6; // r0
  ...
  else if ( (double)*(unsigned int *)a1 > (double)*(unsigned int *)(a1 + 8) * 1.3 && sub_88E94(a1) )
  {
    sub_89984(2, "src/zc_hashtable.c", 205, "rehash fail");
    return -1;
  }
  else
  {
    ...
    {
      v6 = _errno_location();
      sub_89984(2, "src/zc_hashtable.c", 212, "calloc fail, errno[%d]", *v6);
      return -1;
    }
  }
}
