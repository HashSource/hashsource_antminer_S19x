int __fastcall sub_8B298(int a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( !*(_DWORD *)a1 )
  {
    sub_89984(2, "src/buf.c", 434, "pre-use of zlog_buf_resize fail, so can't convert");
    return -1;
  }
  src = &v7;
  do
  {
    src = (char *)src - 1;
    *(_BYTE *)src = a0123456789abcd_0[a2 & 0xF];
    a2 >>= 4;
  }
  while ( a2 );
  v12 = &v7 - (_BYTE *)src;
  ...
  if ( v13 > *(_DWORD *)(a1 + 8) )
  {
    ...
    if ( v9 > 0 )
    {
      sub_89984(2, "src/buf.c", 473, "conf limit to %ld, can't extend, so output", *(_DWORD *)(a1 + 20));
    ...
    if ( v9 < 0 )
    {
      sub_89984(2, "src/buf.c", 489, "zlog_buf_resize fail");
      return -1;
    }
    v13 = *(_DWORD *)(a1 + 4) + v10;
  }
