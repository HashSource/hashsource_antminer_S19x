__int64 __fastcall sub_65364(int a1)
{
  double v1; // r0
  double v3; // r2
  unsigned int v4; // r4
  ...
  v11[1] = 142;
  v13 = 6;
  LODWORD(v1) = sub_62C28(a1, (unsigned __int8 *)v11, 8u, v9, 0xEu);
  if ( LODWORD(v1) )
  {
  ...
  else
  {
    for ( i = 0; i <= 7; ++i )
    {
      ...
      HIDWORD(v3) = 8 * i;
      pow(v1, v3);
      v5 = sub_8CAF4(COERCE_UNSIGNED_INT64(2.0), HIDWORD(COERCE_UNSIGNED_INT64(2.0)), COERCE_UNSIGNED_INT64(2.0));
      v6 = v5;
      LODWORD(v1) = 0;
