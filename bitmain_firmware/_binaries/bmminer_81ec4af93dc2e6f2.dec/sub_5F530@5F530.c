int __fastcall sub_5F530(int a1, unsigned __int8 a2, unsigned __int8 a3, void *a4, int a5)
{
  int v5; // r3
  int v6; // r3
  int v7; // r3
  ...
  *((_BYTE *)&v18 + v7) = v26[1];
  v8 = v25++;
  *((_BYTE *)&v18 + v8) = v26[0];
  v9 = sub_6A9E8(a1, &v18, v25);
  if ( v9 == v25 )
  {
    usleep(0x493E0u);
    v10 = sub_6A93C(a1, ptr, size);
    if ( size == v10 )
    {
      if ( *((_BYTE *)ptr + 1) == 54 && *((_BYTE *)ptr + 2) == 1 && size == *(unsigned __int8 *)ptr )
      {
        ...
        *(_WORD *)v26 = 0;
        ...
        else
        {
          ...
          sub_3AF5C(0, v17, 0, (int)v17);
          sub_5EEA4("read return data", (unsigned __int8 *)ptr, size);
        }
      }
      else
      {
