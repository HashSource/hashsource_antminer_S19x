int __fastcall sub_89C20(const char *a1)
{
      ...
      switch ( v6 )
      {
        ...
        default:
          if ( ((*_ctype_b_loc())[v6] & 0x800) == 0 )
            sub_89984(2, "src/zc_util.c", 70, "Wrong suffix parsing size in bytes for string [%s], ignoring suffix", a1);
          break;
      }
      return v7;
    }
  ...
  {
    sub_89984(2, "src/zc_util.c", 27, "astring is null or 0");
    return 0;
  }
}
