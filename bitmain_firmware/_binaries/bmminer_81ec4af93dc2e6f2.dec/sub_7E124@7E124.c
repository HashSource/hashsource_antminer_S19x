int __fastcall sub_7E124(int a1, const char *a2, int *a3)
{
  size_t v3; // r0
  ...
  if ( strlen(a2) <= 0x1000 )
  {
      ...
      switch ( *a3 )
      {
        case 1:
          ...
          if ( v18 == 2 )
          {
            ...
            {
              *(_DWORD *)(a1 + 1052) = sub_89C20(v11);
              return 0;
            }
            if ( !strcmp(v14, "buffer") && !strcmp(v13, "max") )
            {
              *(_DWORD *)(a1 + 1056) = sub_89C20(v11);
              return 0;
            }
            ...
            {
              *(_DWORD *)(a1 + 9276) = sub_89C20(v11);
              return 0;
            }
            if ( !strcmp(v14, "fsync") && !strcmp(v13, "period") )
            {
              *(_DWORD *)(a1 + 9272) = sub_89C20(v11);
              return 0;
            }
            sub_89984(2, "src/conf.c", 454, "name[%s] is not any one of global options", v15);
            if ( !*(_DWORD *)(a1 + 1048) )
              return 0;
            return -1;
          }
          ...
          {
            sub_89984(2, "src/conf.c", 412, "sscanf [%s] fail, name or value is null", a2);
            return -1;
          }
        case 2:
          if ( !sub_7FDF0(*(_DWORD *)(a1 + 9280), a2) )
            return 0;
          sub_89984(2, "src/conf.c", 460, "zlog_level_list_set fail");
          if ( !*(_DWORD *)(a1 + 1048) )
            return 0;
          return -1;
        case 3:
          v20 = sub_7F5B4(a2, a1 + 9292);
          if ( v20 )
          {
            if ( !sub_888DC(*(_DWORD *)(a1 + 9284), v20) )
              return 0;
            sub_7F518(v20);
            sub_89984(2, "src/conf.c", 473, "zc_arraylist_add fail");
            return -1;
          }
          else
          {
            sub_89984(2, "src/conf.c", 467, "zlog_format_new fail [%s]", a2);
            if ( !*(_DWORD *)(a1 + 1048) )
              return 0;
            return -1;
          }
        case 4:
          ...
          if ( v19 )
          {
            if ( sub_888DC(*(_DWORD *)(a1 + 9288), v19) )
            {
              sub_858AC(v19);
              sub_89984(2, "src/conf.c", 493, "zc_arraylist_add fail");
              return -1;
            }
          }
          else
          {
            sub_89984(2, "src/conf.c", 487, "zlog_rule_new fail [%s]", a2);
            if ( *(_DWORD *)(a1 + 1048) )
              return -1;
          }
          return 0;
        default:
          sub_89984(2, "src/conf.c", 498, "not in any section");
          return -1;
      }
    }
    v17 = *a3;
    ...
    else
    {
      if ( strcmp(v15, "rules") )
      {
        sub_89984(2, "src/conf.c", 363, "wrong section name[%s]", v15);
        return -1;
      }
      *a3 = 4;
    }
    if ( v17 < *a3 )
    {
      if ( *a3 == 4 )
      {
        ...
        *(_DWORD *)(a1 + 5160) = sub_80CAC(a1 + 1060);
        if ( !*(_DWORD *)(a1 + 5160) )
        {
          sub_89984(2, "src/conf.c", 391, "zlog_rotater_new fail");
          return -1;
        }
        *(_DWORD *)(a1 + 9264) = sub_7F5B4(a1 + 5164, a1 + 9292);
        if ( !*(_DWORD *)(a1 + 9264) )
        {
          sub_89984(2, "src/conf.c", 398, "zlog_format_new fail");
          return -1;
        }
      }
      return 0;
    }
    sub_89984(2, "src/conf.c", 368, "wrong sequence of section, must follow global->levels->formats->rules");
    return -1;
  }
  else
  {
    v3 = strlen(a2);
    sub_89984(2, "src/conf.c", 346, "line_len[%ld] > MAXLEN_CFG_LINE[%ld], may cause overflow", v3, 4096);
    return -1;
  }
}
