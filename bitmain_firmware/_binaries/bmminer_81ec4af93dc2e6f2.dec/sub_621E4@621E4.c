size_t __fastcall sub_621E4(unsigned __int8 a1, unsigned __int8 a2, unsigned __int8 a3, void *a4, int a5)
{
  ...
  if ( a1 <= 0xFu )
  {
    if ( dword_9C8A88[2 * a1 + 1] || (v12 = sub_5E4DC(a1), v12 >= 0) )
    {
      v12 = sub_604F8(dword_9C8A88[2 * a1], a2, a3, 0, 0);
      if ( v12 >= 0 )
      {
        usleep(0x2710u);
        return sub_600CC(dword_9C8A88[2 * a1], a2, a4, a5);
      }
      else
      {
