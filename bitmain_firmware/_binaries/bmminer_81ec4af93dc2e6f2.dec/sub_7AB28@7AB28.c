int __fastcall sub_7AB28(int result, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( (((int)*(unsigned __int8 *)(dword_5BA798 + a6 / 8 + 1032) >> (7 - a4)) & 1) != 0 )
  {
    ...
    if ( !dword_5BA7A0 )
    {
      sub_89984(2, "src/zlog.c", 742, "never call zlog_init() or dzlog_init() before");
    ...
    if ( !pointer )
    {
      ...
      if ( !pointer )
      {
        sub_89984(2, "src/zlog.c", 753, "zlog_thread_new fail");
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
      ...
      {
        sub_87E68(pointer);
        sub_89984(2, "src/zlog.c", 753, "pthread_setspecific fail, rd[%d]", v12);
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
    }
    if ( *pointer != dword_5BA7A4 )
    {
      ...
      {
        sub_89984(2, "src/zlog.c", 753, "zlog_thread_resize_msg_buf fail, rd[%d]", v13);
        return pthread_rwlock_unlock(&stru_5BA76C);
      }
      *pointer = dword_5BA7A4;
    }
    sub_7F2EC(pointer[2], dword_5BA798, *(_DWORD *)(dword_5BA798 + 1028), v11, a2, a3, v8, a5, a6, a7, a8);
    if ( sub_7CAA8(dword_5BA798, pointer) )
    {
      sub_89984(2, "src/zlog.c", 761, "zlog_output fail, srcfile[%s], srcline[%ld]", v11, a5);
      return pthread_rwlock_unlock(&stru_5BA76C);
    }
