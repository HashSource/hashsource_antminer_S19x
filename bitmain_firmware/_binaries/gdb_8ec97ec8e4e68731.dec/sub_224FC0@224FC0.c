int __fastcall sub_224FC0(int a1, const char *a2)
{
  _DWORD *v3; // r0
  int v4; // r6
  _DWORD *v5; // r0
  ...
  sub_2594B0(*v3, "-> %s->to_static_tracepoint_markers_by_strid (...)\n", (const char *)dword_489C90);
  v4 = off_489EEC(&unk_489C8C, a2);
  v5 = (_DWORD *)sub_242FC8(v4);
  sub_2594B0(*v5, "<- %s->to_static_tracepoint_markers_by_strid (", (const char *)dword_489C90);
