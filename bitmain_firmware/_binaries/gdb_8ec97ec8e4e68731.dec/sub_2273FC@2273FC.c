int __fastcall sub_2273FC(int a1)
{
  _DWORD *v1; // r0
  int v2; // r5
  _DWORD *v3; // r0
  ...
  sub_2594B0(*v1, "-> %s->to_supports_enable_disable_tracepoint (...)\n", (const char *)dword_489C90);
  v2 = ((int (__fastcall *)(void *))off_489E40)(&unk_489C8C);
  v3 = (_DWORD *)sub_242FC8(v2);
  sub_2594B0(*v3, "<- %s->to_supports_enable_disable_tracepoint (", (const char *)dword_489C90);
