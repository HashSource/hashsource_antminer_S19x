int __fastcall sub_14A0EC(int *a1, int a2, int a3, int a4)
{
  int v8; // r3
  int v9; // r2
  double v10; // r0
  ...
  if ( v16 )
  {
    sub_14A00C((int)a1, v17, (int)&v15, v16);
  ...
  else
  {
    ...
    *(_DWORD *)a4 = v14;
    a1[2] = a4;
    if ( v14 )
      *(_DWORD *)(v11 + 4 * ((unsigned __int64)sub_347674(*(_DWORD *)(*(_DWORD *)a4 + 8), a1[1]) >> 32)) = a4;
