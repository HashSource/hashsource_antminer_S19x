int __fastcall sub_2264DC(int a1, int a2, int a3, unsigned int a4)
{
  _DWORD *v7; // r0
  int v8; // r6
  _DWORD *v9; // r0
  ...
  sub_2594B0(*v7, "-> %s->to_read_btrace (...)\n", (const char *)dword_489C90);
  v8 = off_489F0C(&unk_489C8C, a2, a3, a4);
  v9 = (_DWORD *)sub_242FC8(v8);
  sub_2594B0(*v9, "<- %s->to_read_btrace (", (const char *)dword_489C90);
