void __fastcall sub_2541F8(int a1, int a2, int a3, int a4, int a5, int a6, void *s, int a8)
{
  int v11; // r0
  int v12; // r0
  double v13; // d7
  ...
  ((void (__fastcall *)(int, int, int, double *))loc_2539A8)(a1, v11, a3, &v21);
  v12 = ((int (__fastcall *)(int))loc_173460)(a6);
  ((void (__fastcall *)(int, int, int, double *))loc_2539A8)(a1, v12, a5, &v22);
  switch ( a2 )
  {
    case 1:
      v23 = v21 + v22;
