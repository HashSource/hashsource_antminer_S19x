int __fastcall sub_22AF4C(int a1, int a2, int a3)
{
  _DWORD *v5; // r0
  int v6; // r6
  _DWORD *v7; // r0
  ...
  sub_2594B0(*v5, "-> %s->to_static_tracepoint_marker_at (...)\n", (const char *)dword_489C90);
  v6 = off_489EE8(&unk_489C8C, a2, a3);
  v7 = (_DWORD *)sub_242FC8(v6);
  sub_2594B0(*v7, "<- %s->to_static_tracepoint_marker_at (", (const char *)dword_489C90);
