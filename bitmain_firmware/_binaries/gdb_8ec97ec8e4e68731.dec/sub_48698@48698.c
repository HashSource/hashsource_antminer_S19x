unsigned __int64 __fastcall sub_48698(void *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  _DWORD *v4; // r6
  bool v6; // zf
  int v7; // r3
  ...
  if ( (unsigned __int64)(*(_QWORD *)&dword_46AFC0 + 1LL) > 1 )
    sub_92050(&unk_47266C);
  v4 = &unk_47260C;
  *(_QWORD *)&dword_46AFC0 = 0;
  dword_472678 = 0;
  sub_92080(&unk_47266C);
  sub_92044(&unk_47266C, "<osdata type=\"shared memory\">\n", 30);
  sub_967F0((int)&stream, (int)"/proc/sysvipc/shm", "r");
  v9 = stream;
  if ( stream )
  {
...
LABEL_13:
  sub_92044(&unk_47266C, "</osdata>\n", 11);
  dword_472678 = sub_92094(&unk_47266C);
