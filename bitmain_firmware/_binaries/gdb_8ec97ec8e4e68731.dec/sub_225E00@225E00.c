int __fastcall sub_225E00(int a1, int a2, const char *a3)
{
  _DWORD *v5; // r0
  int v6; // r0
  _DWORD *v7; // r0
  ...
  sub_2594B0(*v5, "-> %s->to_follow_exec (...)\n", (const char *)dword_489C90);
  v6 = off_489D74(&unk_489C8C, a2, a3);
  v7 = (_DWORD *)sub_242FC8(v6);
  sub_2594B0(*v7, "<- %s->to_follow_exec (", (const char *)dword_489C90);
