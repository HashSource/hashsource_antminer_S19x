_DWORD *__fastcall sub_14A5C8(int *a1, int a2, int a3, _DWORD *a4)
{
  int v8; // r3
  int v9; // r2
  double v10; // r0
  ...
  if ( v16 )
  {
    sub_14A4E8((int)a1, v17, (int)&v15, v16);
  ...
  else
  {
    ...
    *a4 = v14;
    a1[2] = (int)a4;
    if ( v14 )
      *(_DWORD *)(v11 + 4 * ((unsigned __int64)sub_347674(*(_DWORD *)(*a4 + 12), a1[1]) >> 32)) = a4;
