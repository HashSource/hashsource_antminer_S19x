int __fastcall sub_22AE80(int a1, int a2, int a3, int a4)
{
  _DWORD *v4; // r0
  int v5; // r0
  _DWORD *v6; // r0
  ...
  sub_2594B0(*v4, "-> %s->to_post_startup_inferior (...)\n", (const char *)dword_489C90);
  v5 = off_489D54(&unk_489C8C, v17, v18, v19);
  v6 = (_DWORD *)sub_242FC8(v5);
  sub_2594B0(*v6, "<- %s->to_post_startup_inferior (", (const char *)dword_489C90);
