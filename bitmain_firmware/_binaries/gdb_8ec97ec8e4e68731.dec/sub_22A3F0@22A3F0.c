int __fastcall sub_22A3F0(int a1, int a2, int a3, int a4, int a5)
{
  _DWORD *v5; // r0
  int v6; // r7
  _DWORD *v7; // r0
  ...
  sub_2594B0(*v5, "-> %s->to_record_will_replay (...)\n", (const char *)dword_489C90);
  v6 = off_489F2C(&unk_489C8C, v26, v27, v28, a5);
  v7 = (_DWORD *)sub_242FC8(v6);
  sub_2594B0(*v7, "<- %s->to_record_will_replay (", (const char *)dword_489C90);
