int __fastcall sub_229254(int a1)
{
  _DWORD *v1; // r0
  int v2; // r5
  _DWORD *v3; // r0
  ...
  sub_2594B0(*v1, "-> %s->to_supports_stopped_by_sw_breakpoint (...)\n", (const char *)dword_489C90);
  v2 = ((int (__fastcall *)(void *))off_489CE4)(&unk_489C8C);
  v3 = (_DWORD *)sub_242FC8(v2);
  sub_2594B0(*v3, "<- %s->to_supports_stopped_by_sw_breakpoint (", (const char *)dword_489C90);
