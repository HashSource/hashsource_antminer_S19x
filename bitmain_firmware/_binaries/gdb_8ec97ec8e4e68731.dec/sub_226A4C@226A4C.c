int __fastcall sub_226A4C(int a1, int a2)
{
  _DWORD *v3; // r0
  int v4; // r0
  _DWORD *v5; // r0
  ...
  sub_2594B0(*v3, "-> %s->to_set_circular_trace_buffer (...)\n", (const char *)dword_489C90);
  v4 = off_489ECC(&unk_489C8C, a2);
  v5 = (_DWORD *)sub_242FC8(v4);
  sub_2594B0(*v5, "<- %s->to_set_circular_trace_buffer (", (const char *)dword_489C90);
