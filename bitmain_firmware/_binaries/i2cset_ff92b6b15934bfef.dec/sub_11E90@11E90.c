  ...
  if ( v0 )
  {
    ...
    if ( stream )
    {
      ...
      while ( 1 )
      {
        ...
        v4 = v3 + 1;
        *v3 = 0;
        format = (char *)sub_11BB8(v3 + 1);
        v5 = strrchr(s, 9);
        v6 = v5 + 1;
        *v5 = 0;
        v32 = (FILE *)sub_11BB8(v5 + 1);
        v7 = strrchr(s, 9);
        v8 = v7 + 1;
        *v7 = 0;
        v36 = (char *)v32 + sub_11BB8(v7 + 1);
...
LABEL_23:
              ...
              {
                v0 = sub_11C60(v0, (int)&v15->_flags + 1);
                v24 = (FILE *)((char *)&v15->_flags + 1);
                if ( !v0 )
                  return 0;
              }
...
LABEL_11:
              ...
              v15 = v34;
              *((_QWORD *)v25 + 1) = *(_QWORD *)&off_12E38[2 * v23];
              v17 = readdir64(v16);
              if ( !v17 )
                goto LABEL_34;
            }
