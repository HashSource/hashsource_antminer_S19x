int __fastcall sub_45E50(int a1, pthread_rwlock_t *a2, int a3, int a4)
{
  int result; // r0
  ...
  do
  {
    ...
    {
      v9 = sub_433C4(a1, a4);
      sub_2D480(a2 + 10, "cgminer.c", "fill_queue", 9452);
      if ( a2[11].__nr_readers )
        v10 = 0;
      else
        a2[11].__nr_readers = (unsigned int)v9;
      sub_2D714(a2 + 10, "cgminer.c", "fill_queue", 9463);
      if ( !v10 )
        sub_35858((void **)&v9, "cgminer.c", "fill_queue", 9467);
    }
