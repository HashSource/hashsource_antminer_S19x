char *__fastcall sub_1EDA4(int a1, int a2)
{
  int v2; // r3
  char *result; // r0
  int v6; // [sp+8h] [bp-14h]
  ...
  v6 = v2 << 6;
  memset((void *)(a1 + 8 + *(_DWORD *)(a1 + 4)), 0, (v2 << 6) - *(_DWORD *)(a1 + 4));
  *(_BYTE *)(a1 + *(_DWORD *)(a1 + 4) + 8) = 0x80;
  *(_BYTE *)(a1 + 8 + v6 - 1) = v7;
  *(_BYTE *)(a1 + 8 + v6 - 2) = BYTE1(v7);
  *(_BYTE *)(a1 + 8 + v6 - 3) = BYTE2(v7);
  *(_BYTE *)(a1 + 8 + v6 - 4) = HIBYTE(v7);
  result = sub_1E75C((char *)a1, a1 + 8, v8);
  for ( i = 0; i <= 7; ++i )
  {
