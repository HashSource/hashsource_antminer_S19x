int __fastcall sub_31028(unsigned __int64 a1, char *a2, size_t a3, int a4)
{
  double v4; // r0
  double v6; // r0
  double v7; // d7
  ...
  if ( a1 < 0xDE0B6B3A7640000LL )
  {
    if ( a1 < v19 )
    {
      if ( a1 < v20 )
      {
        if ( a1 < v21 )
        {
          ...
          {
            v15 = sub_68270(a1, HIDWORD(a1), v23, HIDWORD(v23));
            v4 = sub_68204(v15, HIDWORD(v15));
            v26 = v4 / v24;
            v16 = 77;
          }
        }
        ...
        {
          v14 = sub_68270(a1, HIDWORD(a1), v22, HIDWORD(v22));
          v4 = sub_68204(v14, HIDWORD(v14));
          v26 = v4 / v24;
          v16 = 71;
        }
      }
      ...
      {
        v13 = sub_68270(a1, HIDWORD(a1), v21, HIDWORD(v21));
        v4 = sub_68204(v13, HIDWORD(v13));
        v26 = v4 / v24;
        v16 = 84;
      }
    }
    ...
    {
      v12 = sub_68270(a1, HIDWORD(a1), v20, HIDWORD(v20));
      v4 = sub_68204(v12, HIDWORD(v12));
      v26 = v4 / v24;
      v16 = 80;
    }
  }
  ...
  {
    v11 = sub_68270(a1, HIDWORD(a1), v19, HIDWORD(v19));
    v4 = sub_68204(v11, HIDWORD(v11));
    v26 = v4 / v24;
    v16 = 69;
  }
  if ( a4 )
