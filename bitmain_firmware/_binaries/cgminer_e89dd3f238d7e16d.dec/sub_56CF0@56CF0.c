int __fastcall sub_56CF0(int a1, int a2, unsigned __int8 *a3, unsigned int a4)
{
  size_t v4; // r3
  size_t v6; // r3
  ...
  if ( !memcmp(a3, &a3[v12], n) )
  {
    ...
    while ( v15 <= a2 - a4 )
    {
      ...
      {
        for ( i = n - 1; v14 < i + 1 && a3[i] == *(unsigned __int8 *)(a1 + i + v15); --i )
          ;
        if ( i + 1 < v14 + 1 )
          return a1 + v15;
        v15 += v12;
