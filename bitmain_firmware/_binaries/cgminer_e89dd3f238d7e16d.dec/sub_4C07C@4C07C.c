int __fastcall sub_4C07C(_DWORD *a1)
{
  size_t v1; // r0
  void **v2; // r4
  int v3; // r3
...
LABEL_15:
  ...
  if ( dword_88800 )
  {
    v14 = (*(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 4) - 1) & v60;
    if ( *(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v14) )
      s = (char *)(*(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v14)
                 - *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 20));
    else
      s = 0;
    while ( s )
    {
      if ( v60 == *((_DWORD *)s + 9) && *((_DWORD *)s + 8) == strlen(*(const char **)(a1[1] + 8)) )
      {
      ...
      if ( *((_DWORD *)s + 6) )
        s = (char *)(*((_DWORD *)s + 6) - *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 20));
      else
        s = 0;
    }
  }
  ...
  {
    sa = (char *)sub_1F934(0x28u, "cgminer.c", "add_cgpu", 11375);
    sub_2AF08(sa, *(const void **)(a1[1] + 8), 4u, "cgminer.c", "add_cgpu", 11376);
    *((_DWORD *)sa + 1) = 0;
    a1[2] = *((_DWORD *)sa + 1);
...
LABEL_43:
    ...
    *((_DWORD *)sa + 8) = strlen(sa);
    if ( dword_88800 )
    {
      *((_DWORD *)sa + 2) = *(_DWORD *)(dword_88800 + 8);
      *((_DWORD *)sa + 4) = 0;
      *((_DWORD *)sa + 3) = *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 16)
                          - *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 20);
      *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 16) + 8) = sa;
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 16) = sa + 8;
    }
    else
    {
      *((_DWORD *)sa + 4) = 0;
      ...
      *((_DWORD *)sa + 2) = malloc(0x2Cu);
      if ( !*(_DWORD *)(dword_88800 + 8) )
        exit(-1);
      memset(*(void **)(dword_88800 + 8), 0, 0x2Cu);
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 16) = dword_88800 + 8;
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 4) = 32;
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 8) = 5;
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 20) = 8;
      v2 = *(void ***)(dword_88800 + 8);
      *v2 = malloc(0x180u);
      if ( !**(_DWORD **)(dword_88800 + 8) )
        exit(-1);
      memset(**(void ***)(dword_88800 + 8), 0, 0x180u);
      *(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 40) = -1609490463;
    }
    ++*(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 12);
    v13 = (*(_DWORD *)(*(_DWORD *)(dword_88800 + 8) + 4) - 1) & v38;
    v3 = **(_DWORD **)(dword_88800 + 8) + 12 * v13;
    ++*(_DWORD *)(v3 + 4);
    *((_DWORD *)sa + 6) = *(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v13);
    *((_DWORD *)sa + 5) = 0;
    if ( *(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v13) )
      *(_DWORD *)(*(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v13) + 12) = sa + 8;
    *(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v13) = sa + 8;
    if ( *(_DWORD *)(**(_DWORD **)(dword_88800 + 8) + 12 * v13 + 4) >= (unsigned int)(10
                                                                                    * (*(_DWORD *)(**(_DWORD **)(dword_88800 + 8)
                                                                                                 + 12 * v13
                                                                                                 + 8)
                                                                                     + 1))
      && *(_DWORD *)(*((_DWORD *)sa + 2) + 36) != 1 )
    {
      ...
      *(_DWORD *)(*((_DWORD *)sa + 2) + 24) = (((2 * *(_DWORD *)(*((_DWORD *)sa + 2) + 4) - 1)
                                              & *(_DWORD *)(*((_DWORD *)sa + 2) + 12)) != 0)
                                            + (*(_DWORD *)(*((_DWORD *)sa + 2) + 12) >> (*(_DWORD *)(*((_DWORD *)sa + 2) + 8)
                                                                                       + 1));
      *(_DWORD *)(*((_DWORD *)sa + 2) + 28) = 0;
      for ( k = 0; k < *(_DWORD *)(*((_DWORD *)sa + 2) + 4); ++k )
      {
        for ( m = *(_DWORD **)(**((_DWORD **)sa + 2) + 12 * k); m; m = v11 )
        {
          ...
          if ( ++*((_DWORD *)v10 + 1) > *(_DWORD *)(*((_DWORD *)sa + 2) + 24) )
          {
            ...
            *((_DWORD *)v10 + 2) = sub_679D0(*((_DWORD *)v10 + 1), *(_DWORD *)(*((_DWORD *)sa + 2) + 24));
          }
          m[3] = 0;
          m[4] = *(_DWORD *)v10;
          if ( *(_DWORD *)v10 )
  ...
  sub_2D480(&stru_92FF0, "cgminer.c", "add_cgpu", 11381);
  dword_92F98 = (int)sub_1FAC4((void *)dword_92F98, 4 * (dword_93010 + dword_86E44 + 2), "cgminer.c", "add_cgpu", 11382);
  sub_2D714(&stru_92FF0, "cgminer.c", "add_cgpu", 11383);
  sub_2D2FC(&stru_90DC4, "cgminer.c", "add_cgpu", 11385);
  a1[58] = time(0);
  sub_2D434(&stru_90DC4, "cgminer.c", "add_cgpu", 11387);
  if ( byte_93040 )
  {
    v5 = dword_86E44++;
    v6 = (_DWORD *)(dword_92F98 + 4 * (v5 + dword_93010));
  }
  else
  {
    v7 = dword_93010++;
    v6 = (_DWORD *)(dword_92F98 + 4 * v7);
  }
  *v6 = a1;
  sub_4C00C();
  return 1;
