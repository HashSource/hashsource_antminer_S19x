int __fastcall sub_144E8(int a1, const char **a2)
{
  FILE *v3; // r0
  void *v4; // r0
  int v5; // r0
  ...
  if ( v21 && a1 )
  {
    ...
    if ( v3 )
    {
      ...
      while ( fgets(v12, 512, stream) )
      {
        ...
        v19 = sub_651D4(v4);
        v5 = sub_66A38(v16);
        sub_65420(v19, "code", v5);
        v6 = sub_66A38(s);
        sub_65420(v19, "cause", v6);
        v7 = sub_66A38(v14);
        sub_65420(v19, "suggestion", v7);
        v8 = sub_66A38(v13);
        sub_65420(v19, "timestamp", v8);
        sub_661B4(v20, v19);
      }
      fclose(stream);
      sub_65420(a1, "WARNING", v20);
      return v23;
    }
    else
    {
