int __fastcall sub_32568(int a1, char *a2)
{
  __int64 v2; // d0
  const char *v3; // r3
  ...
  sub_2CFF8(v8, (unsigned int *)(a1 + 192));
  for ( i = 0; i <= 28 && !*((_BYTE *)v8 + i); ++i )
    ;
  v11 = (char *)v8 + i;
  v10 = sub_2CD98(*(unsigned int *)((char *)v8 + i));
  v2 = *(_QWORD *)(a1 + 376);
  round();
  v9 = sub_682D0(v2, HIDWORD(v2));
  sub_31028(*(_QWORD *)(a1 + 232), v7, 0x10u, 0);
  if ( *(_BYTE *)(a1 + 283) )
    v3 = " BLOCK!";
  else
    v3 = byte_6E658;
