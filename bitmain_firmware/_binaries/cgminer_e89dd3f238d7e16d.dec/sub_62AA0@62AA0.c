int __fastcall sub_62AA0(int a1, int a2, int a3)
{
  int v6; // [sp+8h] [bp-2Ch]
  int v7; // [sp+8h] [bp-2Ch]
...
LABEL_6:
  ...
  if ( (*(_DWORD *)(a1 + 52) & 8) != 0 || v6 == 46 || v6 == 69 || v6 == 101 )
  {
    ...
    sub_621A8((_DWORD *)a1, v6);
    if ( sub_646E4(a1 + 40, &v9) )
    {
      sub_61A8C(a3, (_DWORD *)a1, 15, "real number overflow");
      return -1;
    }
    *(_DWORD *)(a1 + 60) = 258;
    *(_QWORD *)(a1 + 64) = v9;
  ...
  {
    sub_621A8((_DWORD *)a1, v6);
    nptr = (char *)sub_64360(a1 + 40);
    *_errno_location() = 0;
    v11 = strtoll(nptr, &endptr, 10);
    if ( *_errno_location() == 34 )
    {
      if ( v11 >= 0 )
        sub_61A8C(a3, (_DWORD *)a1, 15, "too big integer");
      else
        sub_61A8C(a3, (_DWORD *)a1, 15, "too big negative integer");
      return -1;
    }
