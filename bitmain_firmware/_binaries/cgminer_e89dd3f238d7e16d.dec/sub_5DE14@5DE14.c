int __fastcall sub_5DE14(int a1, unsigned int a2)
{
  size_t v3; // r0
  size_t v4; // r0
  ...
  pthread_mutex_init(&stru_8CC2C, 0);
  for ( i = 0; a2 > i; ++i )
  {
    memcpy(&dword_88820[34 * i + 1], (const void *)(a1 + 136 * i + 4), 0x80u);
    dword_88820[34 * i] = *(_DWORD *)(a1 + 136 * i);
    dword_88820[34 * i + 33] = *(_DWORD *)(a1 + 136 * i + 132);
  }
  dword_8CC20 = a2;
  v17 = 22026;
  memset(&s, 0, sizeof(s));
  ...
  *(_WORD *)s.sa_data = htons(v17);
  ...
  if ( fd >= 0 )
  {
    ...
    *(_DWORD *)arg = v17;
    *((_DWORD *)arg + 2) = fd;
    pthread_create(&newthread, &attr, (void *(*)(void *))sub_5D944, arg);
    dword_8CC24 = 1;
    return 0;
  }
  else
