size_t __fastcall sub_5E754(int a1, unsigned __int8 a2, void *a3, int a4)
{
  int v4; // r3
  int v5; // r3
  int v6; // r3
  ...
  *((_BYTE *)v24 + v11) = HIBYTE(v28);
  v12 = v27++;
  *((_BYTE *)v24 + v12) = v28;
  v13 = sub_6F0DC(a1, v24, v27);
  if ( v13 == v27 )
  {
    usleep(0x2710u);
    v14 = sub_6F030(a1, v22, v25);
    if ( v14 == v25 )
    {
      if ( v22[0] == v25 && v22[1] == 60 && v22[2] == 1 )
      {
        v27 = 0;
        v28 = 0;
        while ( v27 < v25 - 2 )
