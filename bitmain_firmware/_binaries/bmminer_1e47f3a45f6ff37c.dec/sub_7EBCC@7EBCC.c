int sub_7EBCC(const char *a1, int a2, int a3, int a4, int a5, int a6, int a7, ...)
{
  int result; // r0
  ...
  if ( !dword_5BF65C )
  {
    sub_8CD10(2, "src/zlog.c", 896, "never call zlog_init() or dzlog_init() before");
  ...
  if ( !pointer )
  {
    ...
    if ( !pointer )
    {
      sub_8CD10(2, "src/zlog.c", 909, "zlog_thread_new fail");
      return pthread_rwlock_unlock(&stru_5BF628);
    }
    ...
    {
      sub_8B204(pointer);
      sub_8CD10(2, "src/zlog.c", 909, "pthread_setspecific fail, rd[%d]", v12);
      return pthread_rwlock_unlock(&stru_5BF628);
    }
  }
  if ( *pointer != dword_5BF660 )
  {
    ...
    {
      sub_8CD10(2, "src/zlog.c", 909, "zlog_thread_resize_msg_buf fail, rd[%d]", v13);
      return pthread_rwlock_unlock(&stru_5BF628);
    }
    *pointer = dword_5BF660;
  }
  sub_826A4(pointer[2], dword_5BF654, *(_DWORD *)(dword_5BF654 + 1028), a1, a2, a3, a4, a5, a6, a7, (char *)va);
  if ( sub_7FE7C(dword_5BF654, pointer) )
  {
    sub_8CD10(2, "src/zlog.c", 918, "zlog_output fail, srcfile[%s], srcline[%ld]", a1, a5);
    return pthread_rwlock_unlock(&stru_5BF628);
  }
