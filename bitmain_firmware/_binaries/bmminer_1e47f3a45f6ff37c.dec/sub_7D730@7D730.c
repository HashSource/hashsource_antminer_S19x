int __fastcall sub_7D730(int result, const char *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( (((int)*(unsigned __int8 *)(result + a7 / 8 + 1032) >> (7 - a7 % 8)) & 1) != 0 )
  {
    ...
    if ( !dword_5BF65C )
    {
      sub_8CD10(2, "src/zlog.c", 647, "never call zlog_init() or dzlog_init() before");
    ...
    if ( !pointer )
    {
      ...
      if ( !pointer )
      {
        sub_8CD10(2, "src/zlog.c", 651, "zlog_thread_new fail");
        return pthread_rwlock_unlock(&stru_5BF628);
      }
      ...
      {
        sub_8B204(pointer);
        sub_8CD10(2, "src/zlog.c", 651, "pthread_setspecific fail, rd[%d]", v13);
        return pthread_rwlock_unlock(&stru_5BF628);
      }
    }
    if ( *pointer != dword_5BF660 )
    {
      ...
      {
        sub_8CD10(2, "src/zlog.c", 651, "zlog_thread_resize_msg_buf fail, rd[%d]", v14);
        return pthread_rwlock_unlock(&stru_5BF628);
      }
      *pointer = dword_5BF660;
    }
    sub_826A4(pointer[2], v12, *(_DWORD *)(v12 + 1028), a2, a3, a4, a5, a6, a7, a8, a9);
    if ( sub_7FE7C(v12, pointer) )
    {
      sub_8CD10(2, "src/zlog.c", 659, "zlog_output fail, srcfile[%s], srcline[%ld]", a2, a6);
      return pthread_rwlock_unlock(&stru_5BF628);
    }
