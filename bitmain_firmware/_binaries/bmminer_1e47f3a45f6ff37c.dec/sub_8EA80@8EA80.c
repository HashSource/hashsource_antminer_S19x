int __fastcall sub_8EA80(int a1, const void *a2, unsigned int a3, int a4, int a5, unsigned int a6, unsigned int a7)
{
  ...
  if ( !*(_DWORD *)a1 )
  {
    sub_8CD10(2, "src/buf.c", 562, "pre-use of zlog_buf_resize fail, so can't convert");
    return -1;
  }
  if ( a7 && a3 >= a7 )
    v15 = a7;
  ...
  if ( *(_DWORD *)(a1 + 8) - *(_DWORD *)(a1 + 4) < v17 )
  {
    v12 = sub_8DA1C(a1, *(_DWORD *)(a1 + 4) - *(_DWORD *)(a1 + 8) + v17);
    if ( v12 > 0 )
    {
      sub_8CD10(2, "src/buf.c", 592, "conf limit to %ld, can't extend, so output", *(_DWORD *)(a1 + 20));
    ...
    if ( v12 < 0 )
    {
      sub_8CD10(2, "src/buf.c", 624, "zlog_buf_resize fail");
      return -1;
    }
  }
  if ( a4 )
