void *__fastcall sub_82488(size_t a1)
{
  int *v1; // r0
  int *v3; // r0
  int *v4; // r0
    ...
    *((_DWORD *)ptr + 93) = calloc(a1, 0x100Cu);
    if ( *((_DWORD *)ptr + 93) )
    {
      *((_DWORD *)ptr + 94) = a1;
      ...
      {
        v4 = _errno_location();
        sub_8CD10(2, "src/event.c", 78, "gethostname fail, errno[%d]", *v4);
        sub_823F4((void **)ptr);
        return 0;
      }
      else
    ...
    {
      v3 = _errno_location();
      sub_8CD10(2, "src/event.c", 67, "calloc fail, errno[%d]", *v3);
      free(ptr);
      return 0;
    }
  }
  ...
  {
    v1 = _errno_location();
    sub_8CD10(2, "src/event.c", 61, "calloc fail, errno[%d]", *v1);
    return 0;
  }
}
