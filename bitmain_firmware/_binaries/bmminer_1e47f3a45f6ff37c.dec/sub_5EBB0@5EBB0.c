int __fastcall sub_5EBB0(int a1, unsigned __int8 a2, unsigned __int8 a3, int a4, int a5)
{
  int v5; // r3
  int v6; // r3
  int v7; // r3
  ...
  v14 = v28++;
  v24[v14] = v29;
  v15 = sub_6F0DC(a1, v24, v28);
  if ( v15 == v28 )
  {
    usleep(0x2710u);
    v16 = sub_6F030(a1, &v23, v25);
    if ( v16 == v25 )
    {
