int __fastcall sub_6BD70(unsigned int a1, unsigned __int8 a2, char a3, int a4, unsigned int a5)
{
  ...
  if ( a1 <= 0xF )
  {
    v15 = sub_6C2E0(v10, v9);
    if ( v15 == -2147482112
      && ((v14 = sub_6B938(v10, (int)&v9, 1u), v14 < 0) || (v15 = sub_6C2E0(v10, v9), v15 == -2147482112)) )
    {
    ...
    else
    {
      ...
      {
        v12 = i + a3;
        v14 = sub_6F30C(dword_536504[17 * v10 + 2 + 2 * v15], (int)&v12, 1, a4 + i, 1u);
        if ( v14 != 1 )
        {
