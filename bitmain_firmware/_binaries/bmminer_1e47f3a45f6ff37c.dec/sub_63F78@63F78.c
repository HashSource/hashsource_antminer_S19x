int __fastcall sub_63F78(int a1, unsigned __int8 a2)
{
  ...
  if ( a1 != 255 )
  {
    if ( sub_615B0(a1, (unsigned __int8 *)&v7, 8u, (unsigned __int8 *)&v5, 8u) )
    {
  ...
  if ( !sub_61420((unsigned __int8 *)&v7, 8u, (unsigned __int8 *)&v5, 8u) )
    return (BYTE1(v6) << 8) | (unsigned __int8)v6;
  strcpy(v4, "get DA conversion N failed\n");
  sub_3B6AC(0, v4, 0, (int)v4);
  return -2147482880;
}
