int __fastcall sub_80EEC(int a1)
{
  int *v1; // r0
  ...
  if ( !sub_90064(a1, v8) )
  {
    ...
    if ( !stream )
    {
      sub_8CD10(2, "src/conf.c", 245, "open configure file[%s] fail", (const char *)a1);
      return -1;
    }
    s = v6;
    memset(v6, 0, 0x1001u);
...
LABEL_29:
        *++i = 0;
        ...
        v17 = sub_814F4(a1, v6, &v5);
        if ( v17 < 0 )
        {
          sub_8CD10(2, "src/conf.c", 314, "parse configure file[%s]line_no[%ld] fail", (const char *)a1, v14);
          sub_8CD10(2, "src/conf.c", 315, "line[%s]", v6);
          goto LABEL_42;
        }
        if ( v17 > 0 )
        {
          sub_8CD10(1, "src/conf.c", 318, "parse configure file[%s]line_no[%ld] fail", (const char *)a1, v14);
          sub_8CD10(1, "src/conf.c", 319, "line[%s]", v6);
          sub_8CD10(1, "src/conf.c", 320, "as strict init is set to false, ignore and go on");
          v17 = 0;
        }
      }
    }
  ...
  v1 = _errno_location();
  sub_8CD10(2, "src/conf.c", 238, "lstat conf file[%s] fail, errno[%d]", (const char *)a1, *v1);
  return -1;
}
