int __fastcall sub_7DF20(int result, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( (((int)*(unsigned __int8 *)(dword_5BF654 + a6 / 8 + 1032) >> (7 - a6 % 8)) & 1) != 0 )
  {
    ...
    if ( !dword_5BF65C )
    {
      sub_8CD10(2, "src/zlog.c", 742, "never call zlog_init() or dzlog_init() before");
    ...
    if ( !pointer )
    {
      ...
      if ( !pointer )
      {
        sub_8CD10(2, "src/zlog.c", 753, "zlog_thread_new fail");
        return pthread_rwlock_unlock(&stru_5BF628);
      }
      ...
      {
        sub_8B204(pointer);
        sub_8CD10(2, "src/zlog.c", 753, "pthread_setspecific fail, rd[%d]", v12);
        return pthread_rwlock_unlock(&stru_5BF628);
      }
    }
    if ( *pointer != dword_5BF660 )
    {
      ...
      {
        sub_8CD10(2, "src/zlog.c", 753, "zlog_thread_resize_msg_buf fail, rd[%d]", v13);
        return pthread_rwlock_unlock(&stru_5BF628);
      }
      *pointer = dword_5BF660;
    }
    sub_826A4(pointer[2], dword_5BF654, *(_DWORD *)(dword_5BF654 + 1028), v11, a2, a3, a4, a5, a6, a7, a8);
    if ( sub_7FE7C(dword_5BF654, pointer) )
    {
      sub_8CD10(2, "src/zlog.c", 761, "zlog_output fail, srcfile[%s], srcline[%ld]", v11, a5);
      return pthread_rwlock_unlock(&stru_5BF628);
    }
