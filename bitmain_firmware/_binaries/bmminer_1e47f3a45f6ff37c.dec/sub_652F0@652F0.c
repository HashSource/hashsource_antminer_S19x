int __fastcall sub_652F0(int a1)
{
  ...
  if ( a1 != 255 )
  {
    if ( sub_615B0(a1, (unsigned __int8 *)&v7, 6u, (unsigned __int8 *)&v4, 0xAu) )
      goto LABEL_3;
    return (HIBYTE(v5) << 24) | (BYTE2(v5) << 16) & 0xFF0000 | (unsigned __int16)(BYTE1(v5) << 8) | (unsigned __int8)v5;
  }
  if ( !sub_61420((unsigned __int8 *)&v7, 6u, (unsigned __int8 *)&v4, 0xAu) )
    return (HIBYTE(v5) << 24) | (BYTE2(v5) << 16) & 0xFF0000 | (unsigned __int16)(BYTE1(v5) << 8) | (unsigned __int8)v5;
LABEL_3:
