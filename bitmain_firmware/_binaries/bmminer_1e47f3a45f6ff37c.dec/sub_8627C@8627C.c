int __fastcall sub_8627C(int a1, int a2)
{
  const char *v3; // r4
  int *v4; // r0
  int *v5; // r0
  ...
  for ( i = 0; *(_DWORD *)(*(_DWORD *)(a1 + 5172) + 4) > i; ++i )
  {
    if ( (*(int (__fastcall **)(_DWORD, int))(*(_DWORD *)(**(_DWORD **)(a1 + 5172) + 4 * i) + 9260))(
           *(_DWORD *)(**(_DWORD **)(a1 + 5172) + 4 * i),
           a2) )
    {
      sub_8CD10(2, "src/rule.c", 245, "zlog_spec_gen_path fail");
      return -1;
    }
  }
  **(_BYTE **)(*(_DWORD *)(a2 + 16) + 4) = 0;
  ...
  {
    sub_8CD10(2, "src/rule.c", 248, "zlog_format_output fail");
    return -1;
  }
  else
  {
    ...
    if ( fd >= 0 )
    {
      if ( write(fd, **(const void ***)(a2 + 28), *(_DWORD *)(*(_DWORD *)(a2 + 28) + 4) - **(_DWORD **)(a2 + 28)) >= 0 )
      {
        if ( *(_DWORD *)(a1 + 6248) )
        {
          if ( ++*(_DWORD *)(a1 + 6252) >= *(_DWORD *)(a1 + 6248) )
          {
            *(_DWORD *)(a1 + 6252) = 0;
            ...
            {
              v6 = _errno_location();
              sub_8CD10(2, "src/rule.c", 267, "fsync[%d] fail, errno[%d]", fd, *v6);
            }
          }
        }
        if ( close(fd) >= 0 )
        ...
        {
          v7 = _errno_location();
          sub_8CD10(2, "src/rule.c", 271, "close fail, maybe cause by write, errno[%d]", *v7);
          return -1;
        }
      }
      else
      {
        v5 = _errno_location();
        sub_8CD10(2, "src/rule.c", 260, "write fail, errno[%d]", *v5);
        close(fd);
        return -1;
      }
    }
    else
    {
      v3 = **(const char ***)(a2 + 16);
      v4 = _errno_location();
      sub_8CD10(2, "src/rule.c", 255, "open file[%s] fail, errno[%d]", v3, *v4);
      return -1;
    }
  }
}
