unsigned int sub_62288()
{
  double v1; // d0
  char v3[2048]; // [sp+Ch] [bp-840h] BYREF
  float v4; // [sp+80Ch] [bp-40h]
  unsigned __int8 v5[32]; // [sp+810h] [bp-3Ch] BYREF
  ...
  v10 = 0;
  v9 = 0;
  if ( sub_61724(dword_536348, (unsigned __int8 *)&v6, 6u, v5, 0xAu) )
  {
    strcpy(v3, "Get power set_volt value failed\n");
    sub_3B6AC(3, v3, 0, (int)v3);
    return 0;
  }
  else
  {
