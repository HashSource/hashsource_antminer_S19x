int __fastcall sub_84624(int a1)
{
  int *v1; // r0
  int v3; // r3
  int v4; // r3
  ...
  v15 = 0;
  v11 = ***(_DWORD ***)(a1 + 1088);
  while ( *(_DWORD *)(*(_DWORD *)(a1 + 1088) + 4) > v15 )
  {
    v11 = *(_DWORD *)(**(_DWORD **)(a1 + 1088) + 4 * v15);
    if ( *(int *)(a1 + 1084) > 0 && *(_DWORD *)(*(_DWORD *)(a1 + 1088) + 4) - *(_DWORD *)(a1 + 1084) > v15 )
    {
      v13 = unlink((const char *)(v11 + 4));
      if ( v13 )
      {
        v1 = _errno_location();
        sub_8CD10(2, "src/rotater.c", 246, "unlink[%s] fail, errno[%d]", (const char *)(v11 + 4), *v1);
        return -1;
      }
    }
    ++v15;
  ...
  else
  {
    ...
    if ( !v3 )
    {
      sub_8CD10(2, "src/rotater.c", 256, "zc_arraylist_get fail");
      return -1;
    }
  ...
  if ( v12 <= 0x400 )
  {
    if ( rename(*(const char **)(a1 + 32), v10) )
    {
      v6 = *(const char **)(a1 + 32);
      v7 = _errno_location();
      sub_8CD10(2, "src/rotater.c", 277, "rename[%s]->[%s] fail, errno[%d]", v6, v10, *v7);
      return -1;
    }
    else
    {
  ...
  {
    v5 = _errno_location();
    sub_8CD10(2, "src/rotater.c", 272, "nwirte[%d], overflow or errno[%d]", v12, *v5);
    return -1;
  }
}
