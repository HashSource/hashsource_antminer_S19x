int __fastcall sub_8E61C(int a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( !*(_DWORD *)a1 )
  {
    sub_8CD10(2, "src/buf.c", 434, "pre-use of zlog_buf_resize fail, so can't convert");
    return -1;
  }
  src = &v7;
  do
  ...
  if ( v13 > *(_DWORD *)(a1 + 8) )
  {
    ...
    if ( v9 > 0 )
    {
      sub_8CD10(2, "src/buf.c", 473, "conf limit to %ld, can't extend, so output", *(_DWORD *)(a1 + 20));
    ...
    if ( v9 < 0 )
    {
      sub_8CD10(2, "src/buf.c", 489, "zlog_buf_resize fail");
      return -1;
    }
    v13 = *(_DWORD *)(a1 + 4) + v10;
  }
