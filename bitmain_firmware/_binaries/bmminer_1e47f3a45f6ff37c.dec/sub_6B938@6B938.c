int __fastcall sub_6B938(unsigned int a1, int a2, unsigned __int8 a3)
{
  int v4; // r1
  ...
  if ( a1 <= 0xF )
  {
    if ( a3 <= 7u )
    {
      ...
      {
        v14 = sub_6C2E0(a1, *(unsigned __int8 *)(a2 + i));
        if ( v14 == -2147482112 )
        {
          v10 = a1;
          v11 = 0;
          ...
          v4 = *((unsigned __int8 *)&unk_536504 + 68 * a1);
          *((_BYTE *)&unk_536504 + 68 * a1) = v4 + 1;
          v14 = v4;
          *((_BYTE *)&unk_536504 + 68 * a1 + 8 * v4 + 4) = *(_BYTE *)(a2 + i);
          *((_DWORD *)&unk_536504 + 17 * a1 + 2 * v14 + 2) = v15;
        }
      }
      return 0;
    }
