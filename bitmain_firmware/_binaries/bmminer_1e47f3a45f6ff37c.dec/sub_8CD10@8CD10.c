int sub_8CD10(int a1, const char *a2, int a3, const char *a4, ...)
{
  __pid_t v5; // r0
  __pid_t v6; // r0
  __pid_t v7; // r0
  ...
  {
    dword_5BF664 = 1;
    dword_5BF668 = (int)getenv("ZLOG_PROFILE_DEBUG");
    dword_5BF66C = (int)getenv("ZLOG_PROFILE_ERROR");
  }
  if ( a1 == 1 )
  {
    if ( !dword_5BF66C )
      return 0;
    stream = (FILE *)fopen64(dword_5BF66C, "a");
    if ( !stream )
      return -1;
    sub_8CCB8(v12, 0x15u);
    v6 = getpid();
  ...
  if ( dword_5BF668 )
  {
    stream = (FILE *)fopen64(dword_5BF668, "a");
    if ( !stream )
      return -1;
    sub_8CCB8(v12, 0x15u);
    v5 = getpid();
