void __fastcall __noreturn sub_3BE34(int a1)
{
  unsigned int v2; // r4
  struct tm *v3; // r6
  size_t v4; // r0
  ...
  if ( a1 )
  {
    ...
    *(_DWORD *)a1 = 0;
    ...
    while ( 1 )
    {
      ...
      {
        v5 = sub_3BAF8(a1, "cglog_init", v11, s);
        if ( !(sub_3BAF8(a1, "cglog_sync", v11, s) | v5) )
        {
