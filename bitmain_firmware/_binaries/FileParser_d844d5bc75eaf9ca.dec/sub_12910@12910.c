int __fastcall sub_12910(const char *a1, char *a2, const char *a3, _BYTE *a4, char a5, char a6, char a7)
{
  size_t v8; // r0
  int v9; // r0
  const char *v10; // r0
  ...
  int v29; // [sp+BB0h] [bp-5Ch]
  int bio_RSA_PUBKEY; // [sp+BB4h] [bp-58h]
  int v31; // [sp+BB8h] [bp-54h]
  int v32; // [sp+BBCh] [bp-50h]
  FILE *v33; // [sp+BC0h] [bp-4Ch]
  FILE *v34; // [sp+BC4h] [bp-48h]
  int v35; // [sp+BC8h] [bp-44h]
  size_t n; // [sp+BCCh] [bp-40h]
  FILE *v37; // [sp+BD0h] [bp-3Ch]
  unsigned int v38; // [sp+BD4h] [bp-38h]
  ...
  if ( v28 >= 2048 )
  {
    ...
    if ( stream )
    {
      ...
      if ( *a4 == 38 )
      {
        printf("miner_type %s\n", a2);
        v8 = strlen(a2);
        v41 = sub_120C4((unsigned __int8 *)a2, v8);
        ...
        if ( v41 == dest )
        {
          ...
          if ( !a7 || (printf("content:%x\n", v40), (v40 & 0xFE00) == 0xFE00) )
          {
            ...
            if ( v49 == (unsigned __int8)a4[1304] )
            {
              ...
              for ( j = 0; v49 > j; ++j )
              {
                v38 = _byteswap_ulong(*(_DWORD *)&a4[5 * j + 1310]);
                v47 += v38;
              ...
              if ( v47 == v43 )
              {
                ...
                if ( v37 )
                {
                  ...
                  v35 = sub_10C88((int)(a4 + 24), n, (int)(a4 + 1048), (int)v25);
                  if ( v35 )
                  {
                  ...
                  else
                  {
                    ...
                    for ( k = 0; v49 > k; ++k )
                    {
                      v32 = _byteswap_ulong(*(_DWORD *)&a4[5 * k + 1310]);
                      sub_10E00(stream, v32, &v24[2 * k + 2], a4[5 * k + 1309], 0, a5);
                    }
                    for ( m = 0; v49 > m; ++m )
                      sub_10E00(stream, 256, &v24[2 * v49 + 2 + 2 * m], a4[5 * m + 1309], 1, a5);
                    ...
                    v31 = 0;
                    bio_RSA_PUBKEY = 0;
                    v31 = BIO_new_mem_buf(a4 + 24, 1024);
                    bio_RSA_PUBKEY = PEM_read_bio_RSA_PUBKEY(v31, 0, 0, 0);
                    if ( bio_RSA_PUBKEY )
                    {
                      v29 = RSA_verify(672, v21, 32, v22, 256, bio_RSA_PUBKEY);
                      if ( bio_RSA_PUBKEY )
