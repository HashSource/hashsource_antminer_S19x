int __fastcall sub_1783C(int a1, int a2, int a3, int a4, int a5, _DWORD *a6, int a7, int a8, int a9, int *a10)
{
  int result; // r0
  int v13; // r2
  _DWORD *v14; // r9
  ...
  if ( a1 )
  {
    ...
    if ( *(_DWORD *)(a3 + 4) >= *(_DWORD *)(a1 + 20) )
      sub_10C38();
    result = sub_177A4(a1, a4);
    if ( result )
    {
      if ( a6 )
        v73 = (unsigned __int8 *)sub_11534(a6, a7, a8, a9);
      mutex = (pthread_mutex_t *)(a1 + 28);
      v89[0] = 0;
      v88[0] = 0;
      if ( pthread_mutex_lock((pthread_mutex_t *)(a1 + 28)) )
        sub_15644("./../lib/isc/log.c", 1452, "((pthread_mutex_lock(((&lctx->lock))) == 0) ? 0 : 34) == 0");
      v13 = 0;
      v14 = *(_DWORD **)(a1 + 52);
      v15 = a1;
      *(_BYTE *)(a1 + 56) = 0;
...
LABEL_26:
          ...
          if ( result )
            sub_15644("./../lib/isc/log.c", 1766, "((pthread_mutex_unlock(((&lctx->lock))) == 0) ? 0 : 34) == 0");
          return result;
        }
      }
      v22 = *(_DWORD *)(v20 + 8);
      ...
      {
        if ( sub_1959C(v85) )
          sub_15644("./../lib/isc/log.c", 1515, "isc_time_now((&isctime)) == 0");
        sub_19FC8(v85, v89, 64);
        v21 = *(_DWORD *)(v20 + 12);
      }
      if ( (v21 & 2) != 0 && !v88[0] )
      {
        if ( a4 < -5 )
        {
          v69 = (const char *)sub_11534((_DWORD *)isc_msgcat, 10, 802, (int)"level");
          sub_FA7C((int)v88, 0x18u, "%s %d: ", v69, a4);
        }
        else if ( a4 <= 0 )
        {
          sub_FA7C((int)v88, 0x18u, "%s: ", (const char *)*(&off_30B04 - a4));
        }
        else
        {
          sub_FA7C((int)v88, 0x18u, "%s %d: ", "debug", a4);
        }
      }
      ...
      {
        sb = (char *)(v15 + 56);
        sub_F0C4(v15 + 56, 0x2000u, v73, a10);
        if ( a5 )
        {
          sub_19258(v85, v14[6], v23);
          if ( sub_1959C(v82) )
            sub_15644("./../lib/isc/log.c", 1562, "isc_time_now((&oldest)) == 0");
          if ( !sub_19B78(v82, v85, v82) && *(_DWORD *)(v15 + 8248) )
          {
            v78 = v20;
            v39 = *(_DWORD *)(v15 + 8248);
            while ( 1 )
            {
              if ( sub_19948(v39 + 4, v82) >= 0 )
              {
          ...
          v65 = strlen(sb);
          v66 = (char *)sub_9A68(0, v65 + 21, 0, 0);
          v67 = v66;
          if ( v66 )
          {
            *(_DWORD *)v66 = v66 + 20;
            sub_108C4(v66 + 20, (unsigned __int8 *)sb, v65 + 1);
            if ( sub_1959C(v67 + 4) )
              sub_15644("./../lib/isc/log.c", 1637, "isc_time_now((&new->time)) == 0");
            v68 = *(_DWORD *)(v15 + 8252);
            if ( v68 )
              *(_DWORD *)(v68 + 16) = v67;
            else
