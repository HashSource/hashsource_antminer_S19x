int __fastcall sub_11640(int a1)
{
  int v2; // r0
  int v3; // r6
  int v4; // r4
...
LABEL_4:
    ...
    else
    {
      if ( len == 28 )
        goto LABEL_3;
      v4 = 23;
      sub_18558(isc_lctx, &off_31128, &isc_modules, -4, "IPv6 structures in kernel and user space do not match.");
      v8 = isc_lctx;
    }
    sub_18558(v8, &off_31128, &isc_modules, -4, "IPv6 is not supported.");
    goto LABEL_4;
  }
  v6 = *_errno_location();
  if ( v6 == 93 || v6 == 97 || v6 == 22 )
    return 23;
  sub_12EAC(v6, v11, 128);
  v7 = (const char *)sub_11534((_DWORD *)isc_msgcat, 1, 101, (int)"failed");
  sub_1557C("./../lib/isc/unix/net.c", 144, "socket() %s: %s", v7, v11);
  return 34;
}
