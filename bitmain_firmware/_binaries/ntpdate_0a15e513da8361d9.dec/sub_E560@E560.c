int __fastcall sub_E560(double a1, unsigned int a2, int a3, int a4, unsigned int a5, _DWORD *a6)
{
  double v6; // d0
  double v7; // kr00_8
  int v9; // r4
  ...
  if ( v6 + v6 == v6 )
  {
    ...
    v10 = *v11;
    if ( !*v11 )
      return sub_DF00(SLODWORD(v7), (unsigned int *)HIDWORD(a1), a2, v100, a3, SLODWORD(a1), a5);
    ...
    while ( v12 );
    LODWORD(a1) = sub_DF00(SLODWORD(v7), (unsigned int *)HIDWORD(v7), a2, v100, a3, SLODWORD(a1), a5);
    return LODWORD(a1);
  }
LABEL_23:
  if ( (a5 & 0x300) != 0 )
...
LABEL_33:
  ...
  while ( 1 )
  {
    if ( v80 >= 1.84467441e19 )
      goto LABEL_35;
    v22 = sub_1C9C0(LODWORD(v80), HIDWORD(v80));
    a1 = COERCE_DOUBLE(sub_1C914(v22, HIDWORD(v22)));
    if ( v80 < a1 )
      --v22;
    if ( v22 == -1 )
    {
LABEL_35:
    ...
    v82 = sub_1C9C0(LODWORD(v23), HIDWORD(v23));
    v25 = COERCE_DOUBLE(sub_1C914(v82, HIDWORD(v82)));
    a1 = COERCE_DOUBLE(sub_1C914(v22, HIDWORD(v22)));
    v26 = v25 * (v80 - a1);
...
LABEL_74:
    ...
    {
      v27 = sub_1C9C0(LODWORD(v26), HIDWORD(v26));
      a1 = COERCE_DOUBLE(sub_1C914(v27, HIDWORD(v27)));
      v28 = a1;
      if ( v26 < a1 )
      {
        --v27;
...
LABEL_161:
  ...
  sub_1C980(v63, HIDWORD(v63), 10, 0);
  v96 = a0123456789abcd_0[v64];
  v65 = sub_1C980(v63, HIDWORD(v63), 10, 0);
  if ( v65 )
  {
    sub_1C980(v65, HIDWORD(v65), 10, 0);
    v97 = a0123456789abcd_0[v66];
  }
  else
  {
    v97 = 48;
...
LABEL_98:
  ...
  do
  {
    sub_1C980(v32, HIDWORD(v32), 10, 0);
    ++v37;
    *v38++ = a0123456789abcd_0[v39];
    v32 = sub_1C980(v32, HIDWORD(v32), 10, 0);
  }
  ...
  do
  {
    sub_1C980(LODWORD(v45), HIDWORD(v45), 10, 0);
    ++v43;
    *v42++ = a0123456789abcd_0[v46];
    a1 = COERCE_DOUBLE(sub_1C980(LODWORD(v45), HIDWORD(v45), 10, 0));
    v45 = a1;
  }
