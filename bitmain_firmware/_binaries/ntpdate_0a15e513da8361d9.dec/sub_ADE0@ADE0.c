int __fastcall sub_ADE0(const char *a1, int a2)
{
  const char *v2; // r5
  int result; // r0
  size_t v5; // r0
  ...
  v2 = a1;
  if ( !a1 )
    sub_10C38("msyslog.c", 469, 0, "fname != ((void *)0)");
      ...
      if ( strcmp(v2, "stdout") )
      {
        ...
        else if ( v2 != (const char *)syslog_abs_fname && *v2 != 47 && getcwd(buf, 0x200u) )
        {
          ...
          if ( v5 > 1 && buf[v5 - 1] == 47 )
            v6 = v5 - 1;
          v7 = v6 + strlen(v2) + 2;
          v8 = (char *)sub_9A68(0, v7, 0, 0);
          sub_FA7C(v8, v7, "%.*s%c%s", v6, buf, 47, v2);
          goto LABEL_18;
        }
        v8 = (char *)sub_9BF0(v2);
LABEL_18:
        if ( debug > 0 )
          sub_AB20("attempting to open log %s\n", v8);
        v9 = (FILE *)fopen64(v8, "a");
LABEL_21:
        if ( !v9 )
        {
          free(v8);
        ...
        if ( a2 && (syslogit || v2 != (const char *)syslog_abs_fname) )
          sub_ABF8(&byte_5, "switching logging to file %s", v8);
