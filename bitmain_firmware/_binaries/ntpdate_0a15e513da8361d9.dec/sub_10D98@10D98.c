int __fastcall sub_10D98(const char *a1, int a2, int a3, const char *a4)
{
  const char *v8; // r10
  ...
  if ( sub_10FD0(v22, 128, &v19) )
  {
    v15 = stderr;
    v16 = sub_10CF4(a3);
    v17 = (const char *)sub_11534(isc_msgcat, 1, 101, "failed");
  ...
  else
  {
    ...
    v9 = stderr;
    v10 = sub_10CF4(a3);
    v11 = (const char *)sub_11534(isc_msgcat, 1, 101, "failed");
