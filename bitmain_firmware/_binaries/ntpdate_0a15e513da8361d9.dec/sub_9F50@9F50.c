int __fastcall sub_9F50(const char *a1, int a2, _WORD *s)
{
  _BOOL4 v6; // r4
  int result; // r0
  int v8; // r3
  ...
  if ( !a1 )
    sub_10C38("is_ip_address.c", 40, 0, "host != ((void *)0)");
  if ( !s )
    sub_10C38("is_ip_address.c", 41, 0, "addr != ((void *)0)");
  memset(s, 0, 0x1Cu);
  v6 = a2 == 0;
