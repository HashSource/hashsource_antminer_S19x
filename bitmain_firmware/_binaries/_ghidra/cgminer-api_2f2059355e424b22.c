// Decompiled: cgminer-api_2f2059355e424b22
...

{
    ...
    __libc_start_main(FUN_00010ebc, in_stack_00000000, &stack0x00000004,
                      0x11109, &DAT_00011145, param_1);
...
/* WARNING: Removing unreachable block (ram,0x000107c6) */
...
/* WARNING: Removing unreachable block (ram,0x000107f2) */

void FUN_000107cc(void)
...
undefined4 FUN_000109f0(char *param_1, char *param_2, uint16_t param_3)
...
byte *FUN_00010df0(byte *param_1)
...
undefined4 FUN_00010ebc(int param_1, undefined4 *param_2)

{
    ...
    if ((param_1 < 2) ||
        ...
        if (local_18 < param_1) {
            iVar1 = local_18 + 1;
            pcVar2 = (char *)FUN_00010df0(param_2[local_18]);
            local_18 = iVar1;
            if (*pcVar2 != '\0') {
                local_c = pcVar2;
            }
        ...
        uVar3 = FUN_000109f0(local_c, local_10, (int)local_12);
    } else {
...
void FUN_00011108(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
