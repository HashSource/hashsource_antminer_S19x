unsigned int __fastcall sub_6C654(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
  unsigned int v4; // r6
  _BOOL4 v5; // r12
  bool v6; // zf
...
LABEL_59:
            ...
            case 'i':
              ...
              sub_6B63C(a1, &v45, v4, 10, v36, 0xAu, v11, v16, v12);
              break;
            case 'e':
LABEL_71:
              v12 |= 0x200u;
              a4 = (int *)((((unsigned int)a4 + 7) & 0xFFFFFFF8) + 8);
LABEL_60:
              sub_6BAF0(COERCE_DOUBLE(__PAIR64__(&v45, a1)), v4, v11, v16, v12, &v46);
              goto LABEL_61;
            case 'g':
LABEL_67:
              v26 = v12 | 0x100;
              if ( !v16 )
                v16 = 1;
              a4 = (int *)((((unsigned int)a4 + 7) & 0xFFFFFFF8) + 8);
              sub_6BAF0(COERCE_DOUBLE(__PAIR64__(&v45, a1)), v4, v11, v16, v26, &v46);
LABEL_61:
              v18 = v46;
              if ( !v46 )
                break;
            ...
            case 'p':
              v33 = *a4++;
              if ( v33 )
                sub_6B63C(a1, &v45, v4, v33, (unsigned int)v33, 0x10u, v11, v16, v12 | 0x88);
              else
                sub_6B490(a1, &v45, v4, "(nil)", v11, -1, v12);
              break;
            case 's':
              v32 = (const char *)*a4++;
              sub_6B490(a1, &v45, v4, v32, v11, v16, v12);
              break;
            case 'u':
              v24 = 10;
              goto LABEL_65;
...
LABEL_65:
              ...
              sub_6B63C(a1, &v45, v4, v24, v28, v24, v11, v16, v25);
              break;
            default:
              break;
          }
