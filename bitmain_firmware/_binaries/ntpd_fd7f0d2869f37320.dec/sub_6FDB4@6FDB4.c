int __fastcall sub_6FDB4(const char *a1, int a2, int a3, const char *a4)
{
  const char *v8; // r10
  ...
  if ( sub_6FFEC(v22, 128, &v19) )
  {
    v15 = stderr;
    v16 = sub_6FD10(a3);
    v17 = (const char *)sub_7487C(isc_msgcat, 1, 101, "failed");
  ...
  else
  {
    ...
    v9 = stderr;
    v10 = sub_6FD10(a3);
    v11 = (const char *)sub_7487C(isc_msgcat, 1, 101, "failed");
