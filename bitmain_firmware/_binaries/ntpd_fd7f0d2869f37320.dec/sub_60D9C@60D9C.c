int sub_60D9C()
{
  ...
  v5 = sub_8D558(LODWORD(v3), HIDWORD(v3)) ^ -v1;
  v4 = v5;
  LODWORD(v5) = 32;
  v6 = v2 < 0.0;
  if ( v2 < 0.0 )
  ...
  v10 = (sub_8D558(LODWORD(v8), HIDWORD(v8)) ^ -(__int64)v9) + v9;
  v11 = v10 + v25;
  v27 = HIDWORD(v10);
  ...
  v18 = sub_8D518(v17 + 500000000, (unsigned __int64)(v17 + 500000000) >> 32, 1000000000, 0);
  v32 = tv_sec;
  v33 = (tv_nsec + 500) / 1000;
  v19 = __CFADD__(v18, v11);
  v20 = v18 + v11;
  sub_66898((int)&v28, HIDWORD(v25) - 2085978496 + v27 + v26 + v19 + v16, &timer);
  v21 = v28;
  v22 = (unsigned int)&unk_F4240 * (unsigned __int64)v20 + 0x80000000;
  if ( (_UNKNOWN *)HIDWORD(v22) == &unk_F4240 )
    v21 = v28 + 1;
  v30 = v21;
  v23 = ((unsigned int)&unk_F4240 * (unsigned __int64)v20 + 0x80000000) >> 32;
  if ( (_UNKNOWN *)HIDWORD(v22) == &unk_F4240 )
    v23 = 0;
  v31 = v23;
  if ( sub_65254(&v30, 0) )
  {
    sub_65D40(3, "step-systime: %m");
    ...
    if ( enable_panic_check )
    {
      ...
      if ( allow_panic )
      {
        sub_65D40(3, "step_systime: allow_panic is TRUE!");
        return 0;
      }
    }
  }
  else
  {
    ...
    sub_60310(v30, v31, v32, v33);
    if ( enable_panic_check && allow_panic )
    {
      sub_65D40(3, "step_systime: allow_panic is TRUE!");
      if ( allow_panic )
        sub_6FC54("systime.c", 589, 2, "!allow_panic");
    }
    return 1;
  }
  return result;
