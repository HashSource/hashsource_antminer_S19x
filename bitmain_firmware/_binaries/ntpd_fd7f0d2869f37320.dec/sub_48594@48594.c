int __fastcall sub_48594(int result)
{
  int v1; // r6
  int v2; // r4
  const char *v3; // r7
  ...
  if ( *(_DWORD *)(*(_DWORD *)v2 + 20) )
  {
    ...
    *(_DWORD *)(*(_DWORD *)v2 + 20) = 0;
    result = (unsigned __int16)sub_3A6D4(result, (bool *)(v2 + 56), 128, (_DWORD *)(v2 + 232));
