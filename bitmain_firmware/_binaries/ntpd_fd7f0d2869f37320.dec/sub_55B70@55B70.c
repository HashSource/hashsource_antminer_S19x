unsigned int __fastcall sub_55B70(int a1)
{
  int v1; // r5
  int v2; // r4
  _DWORD *v3; // r10
  ...
  v2 = *(_DWORD *)(v1 + 84);
  v3 = *(_DWORD **)v2;
  result = (unsigned __int16)sub_3A6D4(a1, v26, 128, v25);
    ...
    *v3 = 2;
           ...
           || sscanf((const char *)(v2 + 56), "%5d%*c%3d%*c%3d", &v23, &v22, &v24) != 3 )
    {
      if ( sscanf((const char *)(v2 + 56), "F%2d", &v21) == 1 && (unsigned int)(v21 - 1) <= 0x4E )
      {
        if ( v21 == 50 )
        {
          return (unsigned int)sub_55298(v1, 3);
        }
        else if ( v21 == 51 )
        {
          return (unsigned int)sub_55298(v1, 4);
        }
        else
        {
          return (unsigned int)sub_55098(v1, (int)"got F%02d - ignoring\n", v21);
        }
      }
      else if ( (*(_DWORD *)(v2 + 56) & 0xFFFFFF) == 0x524556 && *(_BYTE *)(v2 + 62) == 46 )
      {
        result = (unsigned int)sub_55298(v1, 6);
        if ( (ntp_syslogmask & 0x400) != 0 )
          return sub_65D40(6, "TL3: %s", (const char *)(v2 + 56));
      }
      else if ( !strncmp((const char *)(v2 + 56), " TRUETIME Mk III ", 0x11u)
             || !strncmp((const char *)(v2 + 56), " TRUETIME XL", 0xCu) )
      {
        result = (unsigned int)sub_55298(v1, 2);
        if ( (ntp_syslogmask & 0x400) != 0 )
          return sub_65D40(6, "TM/TMD/XL: %s", (const char *)(v2 + 56));
      }
      else
      {
        ...
        {
          result = (unsigned int)sub_55298(v1, 8);
          if ( (ntp_syslogmask & 0x400) != 0 )
            return sub_65D40(6, "TCU-800: %s", (const char *)(v2 + 56));
        }
        else
        {
LABEL_43:
            ...
            && sscanf((const char *)(v2 + 56), "%3d:%2d:%2d:%2d%c", v2 + 192, v2 + 196, v2 + 200, v2 + 204, &v20) == 5 )
          {
            ...
            if ( v17 )
              LOBYTE(v17) = 3;
            *(_BYTE *)(v2 + 40) = v17;
            result = (unsigned int)sub_55298(v1, 9);
            if ( v3[2] )
            {
              if ( v3[4] <= 1u )
                sub_55298(v1, 7);
    ...
    else
    {
      ...
      sub_55098(v1, (int)"GOES: station %s\n", v13);
      return (unsigned int)sub_55298(v1, 5);
    }
  }
  return result;
}
