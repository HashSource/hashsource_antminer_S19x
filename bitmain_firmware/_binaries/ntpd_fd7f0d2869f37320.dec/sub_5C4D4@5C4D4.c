_BYTE *__fastcall sub_5C4D4(int a1)
{
  int v1; // r7
  int *v2; // r9
  int v3; // r4
  ...
  v2 = *(int **)(v1 + 84);
  v3 = *v2;
  result = sub_3A6D4(a1, v21, 128, v20);
  v5 = (int)result;
  if ( !result )
    return result;
  v6 = *(_DWORD *)(v3 + 4);
  ...
  *(_DWORD *)(v3 + 4) = v7;
  ...
  if ( !v8 )
  {
    ...
    if ( !strncmp((const char *)v21, "LA", 2u) )
    {
      sub_6E4B4(v3 + 53);
      return (_BYTE *)write(v2[7], &off_9B764, 2u);
    }
    if ( !strncmp((const char *)v21, (const char *)&off_9B764, 2u) )
    {
      v17 = v3 + 53;
      sub_6E558(v17, " ");
      sub_6E558(v17, s);
      return (_BYTE *)write(v2[7], &off_9B768, 2u);
    }
    if ( !strncmp((const char *)v21, (const char *)&off_9B768, 2u) )
    {
      v18 = v3 + 53;
      sub_6E558(v18, " ");
      sub_6E558(v18, s);
      return (_BYTE *)write(v2[7], &off_9B76C, 2u);
    }
    result = (_BYTE *)strncmp((const char *)v21, (const char *)&off_9B76C, 2u);
    if ( result )
    {
      *(_DWORD *)(v3 + 8) = 1;
      return result;
    ...
    sub_6E558(v3 + 53, " ");
    sub_6E558(v3 + 53, s);
    sub_42D0C(v1 + 16, (const char *)(v3 + 53));
    if ( (*(_DWORD *)(v1 + 76) & 1) != 0 )
      v9 = "O5";
    else
      v9 = "B5";
  ...
  *(_DWORD *)(v3 + 8) = v10;
  ...
  if ( !v11 )
  {
    ...
    *((_BYTE *)v2 + 78) = *(_BYTE *)(v3 + 12);
    sub_6E558((int)(v2 + 14), (char *)(v3 + 13));
    v19 = 32;
