int __fastcall sub_717AC(int a1)
{
  const char *v2; // r6
  char *v3; // r0
  char *v4; // r4
  ...
  v2 = *(const char **)(a1 + 20);
  if ( *(_DWORD *)(a1 + 4) != 3 )
    sub_6FC54((int)"./../lib/isc/log.c", 1157, 0, "channel->type == 3");
...
LABEL_21:
    if ( --v11 >= v12 )
    {
      do
      {
        if ( sub_6D00C((int)&v33, 0x1001u, "%s.%d", v2, v11) <= 0x1000 )
        {
          v14 = sub_7C9D8(&v33);
          v25 = v14 == 38;
          if ( v14 != 38 )
  ...
  do
  {
    ...
    {
      v18 = v11 - 1;
      if ( sub_6D00C((int)&v33, 0x1001u, "%s.%d", v2, v11 - 1) > 0x1000
        || sub_6D00C((int)v34, 0x1001u, "%s.%d", v2, v11) > 0x1000 )
      {
        v16 = 19;
        break;
      }
      v16 = sub_7CA84(&v33, v34);
      v17 = v16 == 38;
      if ( v16 != 38 )
        v17 = v16 == 0;
      if ( !v17 )
...
LABEL_37:
  if ( v12 )
  {
    if ( sub_6D00C((int)v34, 0x1001u, "%s.0", v2) > 0x1000 )
    {
      v20 = 19;
      goto LABEL_41;
    }
    v20 = sub_7CA84(v2, v34);
    v26 = v20 == 38;
    if ( v20 != 38 )
      v26 = v20 == 0;
    if ( !v26 )
