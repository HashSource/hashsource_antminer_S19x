void __fastcall sub_53E30(void *a1)
{
  ...
  else
  {
    ...
    v4 = 2.69595353e67 / v1 - sub_778A4(v3, HIDWORD(v3)) * 6.27710174e57;
    v5 = sub_77970(COERCE_UNSIGNED_INT64(v4 * 2.93873588e-39), HIDWORD(COERCE_UNSIGNED_INT64(v4 * 2.93873588e-39)));
    v6 = v4 - sub_778A4(v5, HIDWORD(v5)) * 3.40282367e38;
    v7 = sub_77970(COERCE_UNSIGNED_INT64(v6 * 5.42101086e-20), HIDWORD(COERCE_UNSIGNED_INT64(v6 * 5.42101086e-20)));
    v8 = sub_778A4(v7, HIDWORD(v7));
    v9 = sub_77970(
  ...
  sub_4C150(a1, v11, 0x20u, (int)"cgminer.c", (int)"set_target", 8310);
}
